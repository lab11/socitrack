...
#define LWB_RESPONSES_PER_SLOT    2
...
#define GLOSSY_MASTER_TIMEOUT_PERIOD   (TIMEOUT_PERIODS  * (GLOSSY_UPDATE_INTERVAL_US / LWB_SLOT_US))
#endif

#ifdef PROTOCOL_ENABLE_MASTER_TAKEOVER
#define GLOSSY_MASTER_TAKEOVER_PERIOD  (TAKEOVER_PERIODS * (GLOSSY_UPDATE_INTERVAL_US / LWB_SLOT_US))
#endif

#define GLOSSY_SCHEDULE_RETRY_SLACK_US 20000
#define GLOSSY_SCHEDULE_RETRY_SLACK_DW (DW_DELAY_FROM_US(GLOSSY_SCHEDULE_RETRY_SLACK_US) & 0xFFFFFFFE)
