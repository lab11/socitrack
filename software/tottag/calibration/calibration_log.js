...
// This file controls the calibration setup as described in https://github.com/lab11/socitrack/software/tottag/calibration/README.md
...
function parse_cmd_args() {
    ...
    for (var i = 0; i < process.argv.length; i++) {
        ...
        // Correct addresses
        if (val == '-target_addr') {
            peripheral_address_0 = process.argv[++i].toLowerCase().replace(/:/g, '');
            peripheral_address_1 = process.argv[++i].toLowerCase().replace(/:/g, '');
            peripheral_address_2 = process.argv[++i].toLowerCase().replace(/:/g, '');
