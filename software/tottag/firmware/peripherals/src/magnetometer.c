...
nrfx_err_t lis3mdl_data_rate_set(stmdev_ctx_t *ctx, lis3mdl_om_t val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_CTRL_REG1, (uint8_t*)&ctrl_reg1, 1);
   if (ret == NRFX_SUCCESS)
   {
...
nrfx_err_t lis3mdl_full_scale_set(stmdev_ctx_t *ctx, lis3mdl_fs_t val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_CTRL_REG2, (uint8_t*)&ctrl_reg2, 1);
   if (ret == NRFX_SUCCESS)
   {
...
nrfx_err_t lis3mdl_operating_mode_set(stmdev_ctx_t *ctx, lis3mdl_md_t val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_CTRL_REG3, (uint8_t*)&ctrl_reg3, 1);
   if (ret == NRFX_SUCCESS)
   {
...
nrfx_err_t lis3mdl_block_data_update_set(stmdev_ctx_t *ctx, uint8_t val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_CTRL_REG5, (uint8_t*)&ctrl_reg5, 1);
   if (ret == NRFX_SUCCESS)
   {
      ctrl_reg5.bdu = val;
...
nrfx_err_t lis3mdl_mag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_STATUS_REG, (uint8_t*)&status_reg, 1);
...
{
   uint8_t buff[6];
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_OUT_X_L, (uint8_t*) buff, 6);
...
{
   uint8_t buff[2];
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_TEMP_OUT_L, (uint8_t*) buff, 2);
   *val = (int16_t)buff[1];
...
{
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_WHO_AM_I, (uint8_t*) buff, 1);
   return ret;
}
...
{
   lis3mdl_ctrl_reg4_t ctrl_reg4;
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_CTRL_REG4, (uint8_t*)&ctrl_reg4, 1);
   if (ret == NRFX_SUCCESS)
   {
...
nrfx_err_t lis3mdl_int_generation_set(stmdev_ctx_t *ctx, uint8_t val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_INT_CFG, (uint8_t*)&int_cfg, 1);
   if (ret == NRFX_SUCCESS)
   {
      int_cfg.ien = val;
...
nrfx_err_t lis3mdl_interrupt_event_flag_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   ...
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_INT_SRC, (uint8_t*)&int_src, 1);
...
nrfx_err_t lis3mdl_int_threshold_set(stmdev_ctx_t *ctx, uint16_t val)
{
   ...
   nrfx_err_t ret = lis3mdl_write_reg(ctx, LIS3MDL_INT_THS_L, buff, 2);
   return ret;
}
...
{
   uint8_t buff[2];
   nrfx_err_t ret = lis3mdl_read_reg(ctx, LIS3MDL_INT_THS_L, buff, 2);
   *val = buff[1];
   *val = (*val * 256U) +  buff[0];
   return ret;
}
