...
static nrfx_err_t lsm6dsox_read_reg(stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len)
{
   // Use SPI directly
...
static nrfx_err_t lsm6dsox_write_reg(stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len)
{
   // Use SPI directly
...
static nrfx_err_t lsm6dsox_mem_bank_set(stmdev_ctx_t *ctx, lsm6dsox_reg_access_t val)
{
   lsm6dsox_func_cfg_access_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FUNC_CFG_ACCESS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_mem_bank_get(stmdev_ctx_t *ctx, lsm6dsox_reg_access_t *val)
{
   lsm6dsox_func_cfg_access_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FUNC_CFG_ACCESS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_mlc_status_get(stmdev_ctx_t *ctx, lsm6dsox_mlc_status_mainpage_t *val)
{
   return lsm6dsox_read_reg(ctx, LSM6DSOX_MLC_STATUS_MAINPAGE, (uint8_t*)val, 1);
}

static nrfx_err_t lsm6dsox_mlc_data_rate_set(stmdev_ctx_t *ctx, lsm6dsox_mlc_odr_t val)
{
   lsm6dsox_emb_func_odr_cfg_c_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_mlc_data_rate_get(stmdev_ctx_t *ctx, lsm6dsox_mlc_odr_t *val)
{
   lsm6dsox_emb_func_odr_cfg_c_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_read_data_raw_get(stmdev_ctx_t *ctx, lsm6dsox_emb_sh_read_t *val, uint8_t len)
{
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fsm_out_get(stmdev_ctx_t *ctx, lsm6dsox_fsm_out_t *val)
{
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fsm_data_rate_set(stmdev_ctx_t *ctx, lsm6dsox_fsm_odr_t val)
{
...
static nrfx_err_t lsm6dsox_fsm_data_rate_get(stmdev_ctx_t *ctx, lsm6dsox_fsm_odr_t *val)
{
   lsm6dsox_emb_func_odr_cfg_b_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fsm_init_set(stmdev_ctx_t *ctx, uint8_t val)
{
...
static nrfx_err_t lsm6dsox_fsm_init_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_emb_func_init_b_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fsm_enable_set(stmdev_ctx_t *ctx, lsm6dsox_emb_fsm_enable_t *val)
{
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fsm_enable_get(stmdev_ctx_t *ctx, lsm6dsox_emb_fsm_enable_t *val)
{
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_embedded_sens_set(stmdev_ctx_t *ctx, lsm6dsox_emb_sens_t *val)
{
...
static nrfx_err_t lsm6dsox_embedded_sens_get(stmdev_ctx_t *ctx, lsm6dsox_emb_sens_t *emb_sens)
{
   lsm6dsox_emb_func_en_a_t emb_func_en_a;
   lsm6dsox_emb_func_en_b_t emb_func_en_b;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
...
static nrfx_err_t lsm6dsox_embedded_sens_off(stmdev_ctx_t *ctx)
{
   lsm6dsox_emb_func_en_a_t emb_func_en_a;
   lsm6dsox_emb_func_en_b_t emb_func_en_b;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
...
static nrfx_err_t lsm6dsox_xl_full_scale_set(stmdev_ctx_t *ctx, lsm6dsox_fs_xl_t val)
{
   lsm6dsox_ctrl1_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL1_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_xl_full_scale_get(stmdev_ctx_t *ctx, lsm6dsox_fs_xl_t *val)
{
   lsm6dsox_ctrl1_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL1_XL, (uint8_t*)&reg, 1);
   switch (reg.fs_xl)
...
static nrfx_err_t lsm6dsox_xl_data_rate_set(stmdev_ctx_t *ctx, lsm6dsox_odr_xl_t val)
{
   ...
   nrfx_err_t ret = lsm6dsox_fsm_enable_get(ctx, &fsm_enable);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_xl_data_rate_get(stmdev_ctx_t *ctx, lsm6dsox_odr_xl_t *val)
{
   lsm6dsox_ctrl1_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL1_XL, (uint8_t*)&reg, 1);
   switch (reg.odr_xl)
...
static nrfx_err_t lsm6dsox_gy_full_scale_set(stmdev_ctx_t *ctx, lsm6dsox_fs_g_t val)
{
   lsm6dsox_ctrl2_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL2_G, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_gy_full_scale_get(stmdev_ctx_t *ctx, lsm6dsox_fs_g_t *val)
{
   lsm6dsox_ctrl2_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL2_G, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_gy_data_rate_set(stmdev_ctx_t *ctx, lsm6dsox_odr_g_t val)
{
...
static nrfx_err_t lsm6dsox_gy_data_rate_get(stmdev_ctx_t *ctx, lsm6dsox_odr_g_t *val)
{
   lsm6dsox_ctrl2_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL2_G, (uint8_t*)&reg, 1);
   switch (reg.odr_g)
...
static nrfx_err_t lsm6dsox_block_data_update_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.bdu = val;
...
static nrfx_err_t lsm6dsox_block_data_update_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   *val = reg.bdu;
...
static nrfx_err_t lsm6dsox_xl_offset_weight_set(stmdev_ctx_t *ctx, lsm6dsox_usr_off_w_t val)
{
   lsm6dsox_ctrl6_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL6_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_xl_offset_weight_get(stmdev_ctx_t *ctx, lsm6dsox_usr_off_w_t *val)
{
   lsm6dsox_ctrl6_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL6_C, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_xl_power_mode_set(stmdev_ctx_t *ctx, lsm6dsox_xl_hm_mode_t val)
{
   lsm6dsox_ctrl5_c_t ctrl5_c;
   lsm6dsox_ctrl6_c_t ctrl6_c;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&ctrl5_c, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_xl_power_mode_get(stmdev_ctx_t *ctx, lsm6dsox_xl_hm_mode_t *val)
{
   lsm6dsox_ctrl5_c_t ctrl5_c;
   lsm6dsox_ctrl6_c_t ctrl6_c;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&ctrl5_c, 1);
...
static nrfx_err_t lsm6dsox_gy_power_mode_set(stmdev_ctx_t *ctx, lsm6dsox_g_hm_mode_t val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_gy_power_mode_get(stmdev_ctx_t *ctx, lsm6dsox_g_hm_mode_t *val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_status_reg_get(stmdev_ctx_t *ctx, lsm6dsox_status_reg_t *val)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_STATUS_REG, (uint8_t*)val, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_status_reg_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_STATUS_REG, (uint8_t*)&reg, 1);
   *val = reg.xlda;
   return ret;
}

static nrfx_err_t lsm6dsox_gy_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_status_reg_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_STATUS_REG, (uint8_t*)&reg, 1);
   *val = reg.gda;
...
static nrfx_err_t lsm6dsox_temp_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_status_reg_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_STATUS_REG, (uint8_t*)&reg, 1);
   *val = reg.tda;
...
static nrfx_err_t lsm6dsox_xl_usr_offset_x_set(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_write_reg(ctx, LSM6DSOX_X_OFS_USR, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_usr_offset_x_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_X_OFS_USR, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_usr_offset_y_set(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_write_reg(ctx, LSM6DSOX_Y_OFS_USR, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_usr_offset_y_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_Y_OFS_USR, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_usr_offset_z_set(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_write_reg(ctx, LSM6DSOX_Z_OFS_USR, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_usr_offset_z_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_Z_OFS_USR, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_xl_usr_offset_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_xl_usr_offset_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_timestamp_rst(stmdev_ctx_t *ctx)
{
   uint8_t rst_val = 0xAA;
   return lsm6dsox_write_reg(ctx, LSM6DSOX_TIMESTAMP2, &rst_val, 1);
}

static nrfx_err_t lsm6dsox_timestamp_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl10_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL10_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_timestamp_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl10_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL10_C, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_timestamp_raw_get(stmdev_ctx_t *ctx, uint32_t *val)
{
   uint8_t buff[4];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TIMESTAMP0, buff, 4);
   *val = buff[3];
   *val = (*val * 256U) +  buff[2];
   *val = (*val * 256U) +  buff[1];
   *val = (*val * 256U) +  buff[0];
...
static nrfx_err_t lsm6dsox_rounding_mode_set(stmdev_ctx_t *ctx, lsm6dsox_rounding_t val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_rounding_mode_get(stmdev_ctx_t *ctx, lsm6dsox_rounding_t *val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   switch (reg.rounding)
...
static nrfx_err_t lsm6dsox_rounding_on_status_set(stmdev_ctx_t *ctx, lsm6dsox_rounding_status_t val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_rounding_on_status_get(stmdev_ctx_t *ctx, lsm6dsox_rounding_status_t *val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_temperature_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_OUT_TEMP_L, buff, 2);
   *val = (int16_t)buff[1];
   *val = (*val * 256) + (int16_t)buff[0];
   return ret;
}

static nrfx_err_t lsm6dsox_angular_rate_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_OUTX_L_G, buff, 6);
...
static nrfx_err_t lsm6dsox_acceleration_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_OUTX_L_A, buff, 6);
   val[0] = (int16_t)buff[1];
   val[0] = (val[0] * 256) + (int16_t)buff[0];
   val[1] = (int16_t)buff[3];
   val[1] = (val[1] * 256) + (int16_t)buff[2];
...
static nrfx_err_t lsm6dsox_fifo_out_raw_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_DATA_OUT_X_L, buff, 6);
   return ret;
}

static nrfx_err_t lsm6dsox_ois_angular_rate_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_OUTX_L_G_OIS, buff, 6);
   val[0] = (int16_t)buff[1];
   val[0] = (val[0] * 256) + (int16_t)buff[0];
   val[1] = (int16_t)buff[3];
   val[1] = (val[1] * 256) + (int16_t)buff[2];
...
static nrfx_err_t lsm6dsox_ois_acceleration_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_OUTX_L_A_OIS, buff, 6);
   val[0] = (int16_t)buff[1];
   val[0] = (val[0] * 256) + (int16_t)buff[0];
   val[1] = (int16_t)buff[3];
   val[1] = (val[1] * 256) + (int16_t)buff[2];
...
static nrfx_err_t lsm6dsox_aux_temperature_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_OUT_TEMP_L, buff, 2);
   *val = (int16_t)buff[1];
   *val = (*val * 256) + (int16_t)buff[0];
   return ret;
}

static nrfx_err_t lsm6dsox_aux_ois_angular_rate_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_OUTX_L_G_OIS, buff, 6);
   val[0] = (int16_t)buff[1];
   val[0] = (val[0] * 256) + (int16_t)buff[0];
   val[1] = (int16_t)buff[3];
   val[1] = (val[1] * 256) + (int16_t)buff[2];
...
static nrfx_err_t lsm6dsox_aux_ois_acceleration_raw_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_OUTX_L_A_OIS, buff, 6);
   val[0] = (int16_t)buff[1];
   val[0] = (val[0] * 256) + (int16_t)buff[0];
   val[1] = (int16_t)buff[3];
   val[1] = (val[1] * 256) + (int16_t)buff[2];
...
static nrfx_err_t lsm6dsox_number_of_steps_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_steps_reset(stmdev_ctx_t *ctx)
{
...
static nrfx_err_t lsm6dsox_mlc_out_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_odr_cal_reg_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_internal_freq_fine_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INTERNAL_FREQ_FINE, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.freq_fine = val;
...
static nrfx_err_t lsm6dsox_odr_cal_reg_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_internal_freq_fine_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INTERNAL_FREQ_FINE, (uint8_t*)&reg, 1);
   *val = reg.freq_fine;
...
static nrfx_err_t lsm6dsox_ln_pg_write_byte(stmdev_ctx_t *ctx, uint16_t address, uint8_t *val)
{
...
static nrfx_err_t lsm6dsox_ln_pg_write(stmdev_ctx_t *ctx, uint16_t address, uint8_t *buf, uint8_t len)
{
   lsm6dsox_page_rw_t page_rw;
   lsm6dsox_page_sel_t page_sel;
   lsm6dsox_page_address_t  page_address;
...
static nrfx_err_t lsm6dsox_ln_pg_read_byte(stmdev_ctx_t *ctx, uint16_t address, uint8_t *val)
{
   lsm6dsox_page_rw_t page_rw;
   lsm6dsox_page_sel_t page_sel;
   lsm6dsox_page_address_t  page_address;
...
static nrfx_err_t lsm6dsox_data_ready_mode_set(stmdev_ctx_t *ctx, lsm6dsox_dataready_pulsed_t val)
{
   lsm6dsox_counter_bdr_reg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_data_ready_mode_get(stmdev_ctx_t *ctx, lsm6dsox_dataready_pulsed_t *val)
{
   lsm6dsox_counter_bdr_reg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_device_id_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WHO_AM_I, buff, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_reset_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_reset_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   *val = reg.sw_reset;
...
static nrfx_err_t lsm6dsox_auto_increment_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_auto_increment_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   *val = reg.if_inc;
...
static nrfx_err_t lsm6dsox_boot_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_boot_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   *val = reg.boot;
...
static nrfx_err_t lsm6dsox_xl_self_test_set(stmdev_ctx_t *ctx, lsm6dsox_st_xl_t val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_xl_self_test_get(stmdev_ctx_t *ctx, lsm6dsox_st_xl_t *val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   switch (reg.st_xl)
...
static nrfx_err_t lsm6dsox_gy_self_test_set(stmdev_ctx_t *ctx, lsm6dsox_st_g_t val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_gy_self_test_get(stmdev_ctx_t *ctx, lsm6dsox_st_g_t *val)
{
   lsm6dsox_ctrl5_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL5_C, (uint8_t*)&reg, 1);
   switch (reg.st_g)
...
static nrfx_err_t lsm6dsox_xl_filter_lp2_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl1_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL1_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_xl_filter_lp2_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl1_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL1_XL, (uint8_t*)&reg, 1);
   *val = reg.lpf2_xl_en;
...
static nrfx_err_t lsm6dsox_gy_filter_lp1_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.lpf1_sel_g = val;
...
static nrfx_err_t lsm6dsox_gy_filter_lp1_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   *val = reg.lpf1_sel_g;
...
static nrfx_err_t lsm6dsox_filter_settling_mask_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_filter_settling_mask_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   *val = reg.drdy_mask;
...
static nrfx_err_t lsm6dsox_gy_lp1_bandwidth_set(stmdev_ctx_t *ctx, lsm6dsox_ftype_t val)
{
   lsm6dsox_ctrl6_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL6_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_gy_lp1_bandwidth_get(stmdev_ctx_t *ctx, lsm6dsox_ftype_t *val)
{
   lsm6dsox_ctrl6_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL6_C, (uint8_t*)&reg, 1);
   switch (reg.ftype)
...
static nrfx_err_t lsm6dsox_xl_lp2_on_6d_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_xl_lp2_on_6d_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_xl_hp_path_on_out_set(stmdev_ctx_t *ctx, lsm6dsox_hp_slope_xl_en_t val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_xl_hp_path_on_out_get(stmdev_ctx_t *ctx, lsm6dsox_hp_slope_xl_en_t *val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_xl_fast_settling_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_xl_fast_settling_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_xl_hp_path_internal_set(stmdev_ctx_t *ctx, lsm6dsox_slope_fds_t val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_xl_hp_path_internal_get(stmdev_ctx_t *ctx, lsm6dsox_slope_fds_t *val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_gy_hp_path_internal_set(stmdev_ctx_t *ctx, lsm6dsox_hpm_g_t val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_gy_hp_path_internal_get(stmdev_ctx_t *ctx, lsm6dsox_hpm_g_t *val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_ois_mode_set(stmdev_ctx_t *ctx, lsm6dsox_spi2_read_en_t val)
{
   lsm6dsox_func_cfg_access_t func_cfg_access;
   lsm6dsox_ui_int_ois_t ui_int_ois;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&ui_int_ois, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_ois_mode_get(stmdev_ctx_t *ctx, lsm6dsox_spi2_read_en_t *val)
{
   lsm6dsox_func_cfg_access_t func_cfg_access;
   lsm6dsox_ui_int_ois_t ui_int_ois;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&ui_int_ois, 1);
...
static nrfx_err_t lsm6dsox_aux_sdo_ocs_mode_set(stmdev_ctx_t *ctx, lsm6dsox_ois_pu_dis_t val)
{
   lsm6dsox_pin_ctrl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_PIN_CTRL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_aux_sdo_ocs_mode_get(stmdev_ctx_t *ctx, lsm6dsox_ois_pu_dis_t *val)
{
   lsm6dsox_pin_ctrl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_PIN_CTRL, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_pw_on_ctrl_set(stmdev_ctx_t *ctx, lsm6dsox_ois_on_t val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_pw_on_ctrl_get(stmdev_ctx_t *ctx, lsm6dsox_ois_on_t *val)
{
   lsm6dsox_ctrl7_g_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL7_G, (uint8_t*)&reg, 1);
   switch (reg.ois_on)
...
static nrfx_err_t lsm6dsox_aux_xl_fs_mode_set(stmdev_ctx_t *ctx, lsm6dsox_xl_fs_mode_t val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_xl_fs_mode_get(stmdev_ctx_t *ctx, lsm6dsox_xl_fs_mode_t *val)
{
   lsm6dsox_ctrl8_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL8_XL, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_status_reg_get(stmdev_ctx_t *ctx, lsm6dsox_spi2_status_reg_ois_t *val)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_STATUS_REG_OIS, (uint8_t*)val, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_aux_xl_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_spi2_status_reg_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_STATUS_REG_OIS, (uint8_t*)&reg, 1);
   *val = reg.xlda;
   return ret;
}

static nrfx_err_t lsm6dsox_aux_gy_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_spi2_status_reg_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_STATUS_REG_OIS, (uint8_t*)&reg, 1);
   *val = reg.gda;
...
static nrfx_err_t lsm6dsox_aux_gy_flag_settling_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_spi2_status_reg_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_SPI2_STATUS_REG_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_den_polarity_set(stmdev_ctx_t *ctx, lsm6dsox_den_lh_ois_t val)
{
   lsm6dsox_ui_int_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_aux_den_polarity_get(stmdev_ctx_t *ctx, lsm6dsox_den_lh_ois_t *val)
{
   lsm6dsox_ui_int_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_den_mode_set(stmdev_ctx_t *ctx, lsm6dsox_lvl2_ois_t val)
{
   lsm6dsox_ui_ctrl1_ois_t ctrl1_ois;
   lsm6dsox_ui_int_ois_t int_ois;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&int_ois, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_aux_den_mode_get(stmdev_ctx_t *ctx, lsm6dsox_lvl2_ois_t *val)
{
   lsm6dsox_ui_ctrl1_ois_t ctrl1_ois;
   lsm6dsox_ui_int_ois_t int_ois;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&int_ois, 1);
...
static nrfx_err_t lsm6dsox_aux_drdy_on_int2_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ui_int_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_drdy_on_int2_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ui_int_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_INT_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_mode_set(stmdev_ctx_t *ctx, lsm6dsox_ois_en_spi2_t val)
{
   lsm6dsox_ui_ctrl1_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL1_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_aux_mode_get(stmdev_ctx_t *ctx, lsm6dsox_ois_en_spi2_t *val)
{
   lsm6dsox_ui_ctrl1_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL1_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_gy_full_scale_set(stmdev_ctx_t *ctx, lsm6dsox_fs_g_ois_t val)
{
   lsm6dsox_ui_ctrl1_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL1_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_gy_full_scale_get(stmdev_ctx_t *ctx, lsm6dsox_fs_g_ois_t *val)
{
   lsm6dsox_ui_ctrl1_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL1_OIS, (uint8_t*)&reg, 1);
   switch (reg.fs_g_ois)
...
static nrfx_err_t lsm6dsox_aux_spi_mode_set(stmdev_ctx_t *ctx, lsm6dsox_sim_ois_t val)
{
   lsm6dsox_ui_ctrl1_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL1_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_spi_mode_get(stmdev_ctx_t *ctx, lsm6dsox_sim_ois_t *val)
{
   lsm6dsox_ui_ctrl1_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL1_OIS, (uint8_t*)&reg, 1);
   switch (reg.sim_ois)
...
static nrfx_err_t lsm6dsox_aux_gy_lp1_bandwidth_set(stmdev_ctx_t *ctx, lsm6dsox_ftype_ois_t val)
{
   lsm6dsox_ui_ctrl2_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL2_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_aux_gy_lp1_bandwidth_get(stmdev_ctx_t *ctx, lsm6dsox_ftype_ois_t *val)
{
   lsm6dsox_ui_ctrl2_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL2_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_gy_hp_bandwidth_set(stmdev_ctx_t *ctx, lsm6dsox_hpm_ois_t val)
{
   lsm6dsox_ui_ctrl2_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL2_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_gy_hp_bandwidth_get(stmdev_ctx_t *ctx, lsm6dsox_hpm_ois_t *val)
{
   lsm6dsox_ui_ctrl2_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL2_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_gy_clamp_set(stmdev_ctx_t *ctx, lsm6dsox_st_ois_clampdis_t val)
{
   lsm6dsox_ui_ctrl3_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL3_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_aux_gy_clamp_get(stmdev_ctx_t *ctx, lsm6dsox_st_ois_clampdis_t *val)
{
   lsm6dsox_ui_ctrl3_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL3_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_xl_bandwidth_set(stmdev_ctx_t *ctx, lsm6dsox_filter_xl_conf_ois_t val)
{
   lsm6dsox_ui_ctrl3_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL3_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_xl_bandwidth_get(stmdev_ctx_t *ctx, lsm6dsox_filter_xl_conf_ois_t *val)
{
   lsm6dsox_ui_ctrl3_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL3_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_aux_xl_full_scale_set(stmdev_ctx_t *ctx, lsm6dsox_fs_xl_ois_t val)
{
   lsm6dsox_ui_ctrl3_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL3_OIS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_aux_xl_full_scale_get(stmdev_ctx_t *ctx, lsm6dsox_fs_xl_ois_t *val)
{
   lsm6dsox_ui_ctrl3_ois_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_UI_CTRL3_OIS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_sdo_sa0_mode_set(stmdev_ctx_t *ctx, lsm6dsox_sdo_pu_en_t val)
{
   lsm6dsox_pin_ctrl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_PIN_CTRL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sdo_sa0_mode_get(stmdev_ctx_t *ctx, lsm6dsox_sdo_pu_en_t *val)
{
   lsm6dsox_pin_ctrl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_PIN_CTRL, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_spi_mode_set(stmdev_ctx_t *ctx, lsm6dsox_sim_t val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_spi_mode_get(stmdev_ctx_t *ctx, lsm6dsox_sim_t *val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   switch (reg.sim)
...
static nrfx_err_t lsm6dsox_i2c_interface_set(stmdev_ctx_t *ctx, lsm6dsox_i2c_disable_t val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_i2c_interface_get(stmdev_ctx_t *ctx, lsm6dsox_i2c_disable_t *val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_i3c_disable_set(stmdev_ctx_t *ctx, lsm6dsox_i3c_disable_t val)
{
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   lsm6dsox_ctrl9_xl_t ctrl9_xl;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&ctrl9_xl, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_i3c_disable_get(stmdev_ctx_t *ctx, lsm6dsox_i3c_disable_t *val)
{
   lsm6dsox_ctrl9_xl_t ctrl9_xl;
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&ctrl9_xl, 1);
...
static nrfx_err_t lsm6dsox_pin_mode_set(stmdev_ctx_t *ctx, lsm6dsox_pp_od_t val)
{
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   lsm6dsox_ctrl3_c_t ctrl3_c;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&ctrl3_c, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_pin_mode_get(stmdev_ctx_t *ctx, lsm6dsox_pp_od_t *val)
{
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   lsm6dsox_ctrl3_c_t ctrl3_c;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&ctrl3_c, 1);
...
static nrfx_err_t lsm6dsox_pin_polarity_set(stmdev_ctx_t *ctx, lsm6dsox_h_lactive_t val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_pin_polarity_get(stmdev_ctx_t *ctx, lsm6dsox_h_lactive_t *val)
{
   lsm6dsox_ctrl3_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_all_on_int1_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_all_on_int1_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_int_notification_set(stmdev_ctx_t *ctx, lsm6dsox_lir_t val)
{
   lsm6dsox_tap_cfg0_t tap_cfg0;
   lsm6dsox_page_rw_t page_rw;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&tap_cfg0, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_int_notification_get(stmdev_ctx_t *ctx, lsm6dsox_lir_t *val)
{
   lsm6dsox_tap_cfg0_t tap_cfg0;
   lsm6dsox_page_rw_t page_rw;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&tap_cfg0, 1);
...
static nrfx_err_t lsm6dsox_wkup_ths_weight_set(stmdev_ctx_t *ctx, lsm6dsox_wake_ths_w_t val)
{
   lsm6dsox_wake_up_dur_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_wkup_ths_weight_get(stmdev_ctx_t *ctx, lsm6dsox_wake_ths_w_t *val)
{
   lsm6dsox_wake_up_dur_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_wkup_threshold_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_wake_up_ths_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_THS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.wk_ths = val;
...
static nrfx_err_t lsm6dsox_wkup_threshold_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_wake_up_ths_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_THS, (uint8_t*)&reg, 1);
   *val = reg.wk_ths;
...
static nrfx_err_t lsm6dsox_xl_usr_offset_on_wkup_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_wake_up_ths_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_THS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_xl_usr_offset_on_wkup_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_wake_up_ths_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_THS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_wkup_dur_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_wake_up_dur_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_wkup_dur_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_wake_up_dur_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&reg, 1);
   *val = reg.wake_dur;
...
static nrfx_err_t lsm6dsox_gy_sleep_mode_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_gy_sleep_mode_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl4_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&reg, 1);
   *val = reg.sleep_g;
...
static nrfx_err_t lsm6dsox_act_pin_notification_set(stmdev_ctx_t *ctx, lsm6dsox_sleep_status_on_int_t val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_act_pin_notification_get(stmdev_ctx_t *ctx, lsm6dsox_sleep_status_on_int_t *val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_act_mode_set(stmdev_ctx_t *ctx, lsm6dsox_inact_en_t val)
{
   lsm6dsox_tap_cfg2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_act_mode_get(stmdev_ctx_t *ctx, lsm6dsox_inact_en_t *val)
{
   lsm6dsox_tap_cfg2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG2, (uint8_t*)&reg, 1);
   switch (reg.inact_en)
...
static nrfx_err_t lsm6dsox_act_sleep_dur_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_wake_up_dur_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_act_sleep_dur_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_wake_up_dur_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&reg, 1);
   *val = reg.sleep_dur;
...
static nrfx_err_t lsm6dsox_tap_detection_on_z_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_detection_on_z_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   *val = reg.tap_z_en;
...
static nrfx_err_t lsm6dsox_tap_detection_on_y_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_detection_on_y_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   *val = reg.tap_y_en;
...
static nrfx_err_t lsm6dsox_tap_detection_on_x_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_detection_on_x_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_cfg0_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG0, (uint8_t*)&reg, 1);
   *val = reg.tap_x_en;
...
static nrfx_err_t lsm6dsox_tap_threshold_x_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_cfg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG1, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.tap_ths_x = val;
...
static nrfx_err_t lsm6dsox_tap_threshold_x_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_cfg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG1, (uint8_t*)&reg, 1);
   *val = reg.tap_ths_x;
...
static nrfx_err_t lsm6dsox_tap_axis_priority_set(stmdev_ctx_t *ctx, lsm6dsox_tap_priority_t val)
{
   lsm6dsox_tap_cfg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG1, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_axis_priority_get(stmdev_ctx_t *ctx, lsm6dsox_tap_priority_t *val)
{
   lsm6dsox_tap_cfg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG1, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_tap_threshold_y_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_cfg2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_threshold_y_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_cfg2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_CFG2, (uint8_t*)&reg, 1);
   *val = reg.tap_ths_y;
...
static nrfx_err_t lsm6dsox_tap_threshold_z_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_ths_6d_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_THS_6D, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.tap_ths_z = val;
...
static nrfx_err_t lsm6dsox_tap_threshold_z_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_ths_6d_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_THS_6D, (uint8_t*)&reg, 1);
   *val = reg.tap_ths_z;
...
static nrfx_err_t lsm6dsox_tap_shock_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_int_dur2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INT_DUR2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.shock = val;
...
static nrfx_err_t lsm6dsox_tap_shock_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_int_dur2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INT_DUR2, (uint8_t*)&reg, 1);
   *val = reg.shock;
...
static nrfx_err_t lsm6dsox_tap_quiet_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_int_dur2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INT_DUR2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_quiet_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_int_dur2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INT_DUR2, (uint8_t*)&reg, 1);
   *val = reg.quiet;
...
static nrfx_err_t lsm6dsox_tap_dur_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_int_dur2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INT_DUR2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_dur_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_int_dur2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_INT_DUR2, (uint8_t*)&reg, 1);
   *val = reg.dur;
...
static nrfx_err_t lsm6dsox_tap_mode_set(stmdev_ctx_t *ctx, lsm6dsox_single_double_tap_t val)
{
   lsm6dsox_wake_up_ths_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_THS, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tap_mode_get(stmdev_ctx_t *ctx, lsm6dsox_single_double_tap_t *val)
{
   lsm6dsox_wake_up_ths_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_THS, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_6d_threshold_set(stmdev_ctx_t *ctx, lsm6dsox_sixd_ths_t val)
{
   lsm6dsox_tap_ths_6d_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_THS_6D, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_6d_threshold_get(stmdev_ctx_t *ctx, lsm6dsox_sixd_ths_t *val)
{
   lsm6dsox_tap_ths_6d_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_THS_6D, (uint8_t*)&reg, 1);
   switch (reg.sixd_ths)
...
static nrfx_err_t lsm6dsox_4d_mode_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_tap_ths_6d_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_THS_6D, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_4d_mode_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_tap_ths_6d_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_TAP_THS_6D, (uint8_t*)&reg, 1);
   *val = reg.d4d_en;
...
static nrfx_err_t lsm6dsox_ff_threshold_set(stmdev_ctx_t *ctx, lsm6dsox_ff_ths_t val)
{
   lsm6dsox_free_fall_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FREE_FALL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_ff_threshold_get(stmdev_ctx_t *ctx, lsm6dsox_ff_ths_t *val)
{
   lsm6dsox_free_fall_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FREE_FALL, (uint8_t*)&reg, 1);
   switch (reg.ff_ths)
...
static nrfx_err_t lsm6dsox_ff_dur_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_wake_up_dur_t wake_up_dur;
   lsm6dsox_free_fall_t free_fall;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&wake_up_dur, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_ff_dur_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_wake_up_dur_t wake_up_dur;
   lsm6dsox_free_fall_t free_fall;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_WAKE_UP_DUR, (uint8_t*)&wake_up_dur, 1);
...
static nrfx_err_t lsm6dsox_fifo_watermark_set(stmdev_ctx_t *ctx, uint16_t val)
{
   lsm6dsox_fifo_ctrl1_t fifo_ctrl1;
   lsm6dsox_fifo_ctrl2_t fifo_ctrl2;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&fifo_ctrl2, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_fifo_watermark_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   lsm6dsox_fifo_ctrl1_t fifo_ctrl1;
   lsm6dsox_fifo_ctrl2_t fifo_ctrl2;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL1, (uint8_t*)&fifo_ctrl1, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_compression_algo_init_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_emb_func_init_b_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_compression_algo_init_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_emb_func_init_b_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_compression_algo_set(stmdev_ctx_t *ctx, lsm6dsox_uncoptr_rate_t val)
{
   lsm6dsox_fifo_ctrl2_t fifo_ctrl2;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&fifo_ctrl2, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_compression_algo_get(stmdev_ctx_t *ctx, lsm6dsox_uncoptr_rate_t *val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_fifo_virtual_sens_odr_chg_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fifo_virtual_sens_odr_chg_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
   *val = reg.odrchg_en;
...
static nrfx_err_t lsm6dsox_compression_algo_real_time_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_compression_algo_real_time_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_fifo_stop_on_wtm_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fifo_stop_on_wtm_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_fifo_ctrl2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL2, (uint8_t*)&reg, 1);
   *val = reg.stop_on_wtm;
...
static nrfx_err_t lsm6dsox_fifo_xl_batch_set(stmdev_ctx_t *ctx, lsm6dsox_bdr_xl_t val)
{
   lsm6dsox_fifo_ctrl3_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL3, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_fifo_xl_batch_get(stmdev_ctx_t *ctx, lsm6dsox_bdr_xl_t *val)
{
   lsm6dsox_fifo_ctrl3_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL3, (uint8_t*)&reg, 1);
   switch (reg.bdr_xl)
...
static nrfx_err_t lsm6dsox_fifo_gy_batch_set(stmdev_ctx_t *ctx, lsm6dsox_bdr_gy_t val)
{
   lsm6dsox_fifo_ctrl3_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL3, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fifo_gy_batch_get(stmdev_ctx_t *ctx, lsm6dsox_bdr_gy_t *val)
{
   lsm6dsox_fifo_ctrl3_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL3, (uint8_t*)&reg, 1);
   switch (reg.bdr_gy)
...
static nrfx_err_t lsm6dsox_fifo_mode_set(stmdev_ctx_t *ctx, lsm6dsox_fifo_mode_t val)
{
   lsm6dsox_fifo_ctrl4_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL4, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_fifo_mode_get(stmdev_ctx_t *ctx, lsm6dsox_fifo_mode_t *val)
{
   lsm6dsox_fifo_ctrl4_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL4, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_fifo_temp_batch_set(stmdev_ctx_t *ctx, lsm6dsox_odr_t_batch_t val)
{
   lsm6dsox_fifo_ctrl4_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL4, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fifo_temp_batch_get(stmdev_ctx_t *ctx, lsm6dsox_odr_t_batch_t *val)
{
   lsm6dsox_fifo_ctrl4_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL4, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_fifo_timestamp_decimation_set(stmdev_ctx_t *ctx, lsm6dsox_odr_ts_batch_t val)
{
   lsm6dsox_fifo_ctrl4_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL4, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fifo_timestamp_decimation_get(stmdev_ctx_t *ctx, lsm6dsox_odr_ts_batch_t *val)
{
   lsm6dsox_fifo_ctrl4_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_CTRL4, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_fifo_cnt_event_batch_set(stmdev_ctx_t *ctx, lsm6dsox_trig_counter_bdr_t val)
{
   lsm6dsox_counter_bdr_reg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_fifo_cnt_event_batch_get(stmdev_ctx_t *ctx, lsm6dsox_trig_counter_bdr_t *val)
{
   lsm6dsox_counter_bdr_reg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_rst_batch_counter_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_counter_bdr_reg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_rst_batch_counter_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_counter_bdr_reg1_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_batch_counter_threshold_set(stmdev_ctx_t *ctx, uint16_t val)
{
   lsm6dsox_counter_bdr_reg1_t counter_bdr_reg1;
   lsm6dsox_counter_bdr_reg2_t counter_bdr_reg2;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&counter_bdr_reg1, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_batch_counter_threshold_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   lsm6dsox_counter_bdr_reg1_t counter_bdr_reg1;
   lsm6dsox_counter_bdr_reg2_t counter_bdr_reg2;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_COUNTER_BDR_REG1, (uint8_t*)&counter_bdr_reg1, 1);
...
static nrfx_err_t lsm6dsox_fifo_data_level_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   lsm6dsox_fifo_status1_t fifo_status1;
   lsm6dsox_fifo_status2_t fifo_status2;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_STATUS1, (uint8_t*)&fifo_status1, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_fifo_status_get(stmdev_ctx_t *ctx, lsm6dsox_fifo_status2_t *val)
{
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_STATUS2, (uint8_t*)val, 1);
   return ret;
}

static nrfx_err_t lsm6dsox_fifo_full_flag_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_fifo_status2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_STATUS2, (uint8_t*)&reg, 1);
   *val = reg.fifo_full_ia;
   return ret;
}

static nrfx_err_t lsm6dsox_fifo_ovr_flag_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_fifo_status2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_STATUS2, (uint8_t*)&reg, 1);
   *val = reg.fifo_ovr_ia;
...
static nrfx_err_t lsm6dsox_fifo_wtm_flag_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_fifo_status2_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_STATUS2, (uint8_t*)&reg, 1);
   *val = reg.fifo_wtm_ia;
...
static nrfx_err_t lsm6dsox_fifo_sensor_tag_get(stmdev_ctx_t *ctx, lsm6dsox_fifo_tag_t *val)
{
   lsm6dsox_fifo_data_out_tag_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FIFO_DATA_OUT_TAG, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_fifo_pedo_batch_set(stmdev_ctx_t *ctx, uint8_t val)
{
...
static nrfx_err_t lsm6dsox_fifo_pedo_batch_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_emb_func_fifo_cfg_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_batch_slave_0_set(stmdev_ctx_t *ctx, uint8_t val)
{
...
static nrfx_err_t lsm6dsox_sh_batch_slave_0_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_slv0_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_batch_slave_1_set(stmdev_ctx_t *ctx, uint8_t val)
{
...
static nrfx_err_t lsm6dsox_sh_batch_slave_1_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_slv1_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_batch_slave_2_set(stmdev_ctx_t *ctx, uint8_t val)
{
...
static nrfx_err_t lsm6dsox_sh_batch_slave_2_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_slv2_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_batch_slave_3_set(stmdev_ctx_t *ctx, uint8_t val)
{
...
static nrfx_err_t lsm6dsox_sh_batch_slave_3_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_slv3_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_den_mode_set(stmdev_ctx_t *ctx, lsm6dsox_den_mode_t val)
{
   lsm6dsox_ctrl6_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL6_C, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_den_mode_get(stmdev_ctx_t *ctx, lsm6dsox_den_mode_t *val)
{
   lsm6dsox_ctrl6_c_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL6_C, (uint8_t*)&reg, 1);
   switch (reg.den_mode)
...
static nrfx_err_t lsm6dsox_den_polarity_set(stmdev_ctx_t *ctx, lsm6dsox_den_lh_t val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_den_polarity_get(stmdev_ctx_t *ctx, lsm6dsox_den_lh_t *val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   switch (reg.den_lh)
...
static nrfx_err_t lsm6dsox_den_enable_set(stmdev_ctx_t *ctx, lsm6dsox_den_xl_g_t val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_den_enable_get(stmdev_ctx_t *ctx, lsm6dsox_den_xl_g_t *val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   switch (reg.den_xl_g)
...
static nrfx_err_t lsm6dsox_den_mark_axis_x_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_den_mark_axis_x_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   *val = reg.den_z;
...
static nrfx_err_t lsm6dsox_den_mark_axis_y_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_den_mark_axis_y_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   *val = reg.den_y;
...
static nrfx_err_t lsm6dsox_den_mark_axis_z_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_den_mark_axis_z_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_ctrl9_xl_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL9_XL, (uint8_t*)&reg, 1);
   *val = reg.den_x;
...
static nrfx_err_t lsm6dsox_pedo_sens_set(stmdev_ctx_t *ctx, lsm6dsox_pedo_md_t val)
{
   lsm6dsox_pedo_cmd_reg_t pedo_cmd_reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_PEDO_CMD_REG, (uint8_t*)&pedo_cmd_reg);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_pedo_sens_get(stmdev_ctx_t *ctx, lsm6dsox_pedo_md_t *val)
{
   lsm6dsox_pedo_cmd_reg_t pedo_cmd_reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_PEDO_CMD_REG, (uint8_t*)&pedo_cmd_reg);
...
static nrfx_err_t lsm6dsox_pedo_step_detect_get(stmdev_ctx_t *ctx, uint8_t *val)
{
...
static nrfx_err_t lsm6dsox_pedo_debounce_steps_set(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_PEDO_DEB_STEPS_CONF, buff);
   return ret;
}

static nrfx_err_t lsm6dsox_pedo_debounce_steps_get(stmdev_ctx_t *ctx, uint8_t *buff)
{
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_PEDO_DEB_STEPS_CONF, buff);
   return ret;
}

static nrfx_err_t lsm6dsox_pedo_steps_period_set(stmdev_ctx_t *ctx, uint16_t val)
{
   uint8_t buff[2];
   buff[1] = (uint8_t) (val / 256U);
   buff[0] = (uint8_t) (val - (buff[1] * 256U));
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_PEDO_SC_DELTAT_L, &buff[0]);
   if (ret == NRFX_SUCCESS)
      ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_PEDO_SC_DELTAT_H, &buff[1]);
   return ret;
}

static nrfx_err_t lsm6dsox_pedo_steps_period_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_PEDO_SC_DELTAT_L, &buff[0]);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_pedo_int_mode_set(stmdev_ctx_t *ctx, lsm6dsox_carry_count_en_t val)
{
   lsm6dsox_pedo_cmd_reg_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_PEDO_CMD_REG, (uint8_t*)&reg);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_pedo_int_mode_get(stmdev_ctx_t *ctx, lsm6dsox_carry_count_en_t *val)
{
   lsm6dsox_pedo_cmd_reg_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_PEDO_CMD_REG, (uint8_t*)&reg);
...
static nrfx_err_t lsm6dsox_motion_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_emb_func_status_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_tilt_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_emb_func_status_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_mag_sensitivity_set(stmdev_ctx_t *ctx, uint16_t val)
{
   uint8_t buff[2];
   buff[1] = (uint8_t) (val / 256U);
   buff[0] = (uint8_t) (val - (buff[1] * 256U));
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_MAG_SENSITIVITY_L, &buff[0]);
   if (ret == NRFX_SUCCESS)
      ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_MAG_SENSITIVITY_H, &buff[1]);
   return ret;
}

static nrfx_err_t lsm6dsox_sh_mag_sensitivity_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_SENSITIVITY_L, &buff[0]);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_mlc_mag_sensitivity_set(stmdev_ctx_t *ctx, uint16_t val)
{
   uint8_t buff[2];
   buff[1] = (uint8_t) (val / 256U);
   buff[0] = (uint8_t) (val - (buff[1] * 256U));
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_MLC_MAG_SENSITIVITY_L, &buff[0]);
   if (ret == NRFX_SUCCESS)
      ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_MLC_MAG_SENSITIVITY_H, &buff[1]);
   return ret;
}

static nrfx_err_t lsm6dsox_mlc_mag_sensitivity_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MLC_MAG_SENSITIVITY_L, &buff[0]);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_mag_offset_set(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   uint8_t i;
   ...
   i = 0x00U;
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_MAG_OFFX_L, &buff[i]);
   if (ret == NRFX_SUCCESS)
   {
      i++;
...
static nrfx_err_t lsm6dsox_mag_offset_get(stmdev_ctx_t *ctx, int16_t *val)
{
   uint8_t buff[6];
   uint8_t i = 0x00U;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_OFFX_L, &buff[i]);
   if (ret == NRFX_SUCCESS)
   {
      i++;
...
static nrfx_err_t lsm6dsox_mag_soft_iron_set(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[12];
   uint8_t index;
   ...
   index = 0x00U;
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_MAG_SI_XX_L, &buff[index]);
   if (ret == NRFX_SUCCESS)
   {
      index++;
...
static nrfx_err_t lsm6dsox_mag_soft_iron_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[12];
   uint8_t index = 0x00U;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_SI_XX_L, &buff[index]);
   if (ret == NRFX_SUCCESS)
   {
      index++;
...
static nrfx_err_t lsm6dsox_mag_z_orient_set(stmdev_ctx_t *ctx, lsm6dsox_mag_z_axis_t val)
{
   lsm6dsox_mag_cfg_a_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_CFG_A, (uint8_t*)&reg);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_mag_z_orient_get(stmdev_ctx_t *ctx, lsm6dsox_mag_z_axis_t *val)
{
   lsm6dsox_mag_cfg_a_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_CFG_A, (uint8_t*)&reg);
...
static nrfx_err_t lsm6dsox_mag_y_orient_set(stmdev_ctx_t *ctx, lsm6dsox_mag_y_axis_t val)
{
   lsm6dsox_mag_cfg_a_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_CFG_A, (uint8_t*)&reg);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_mag_y_orient_get(stmdev_ctx_t *ctx, lsm6dsox_mag_y_axis_t *val)
{
   lsm6dsox_mag_cfg_a_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_CFG_A, (uint8_t*)&reg);
...
static nrfx_err_t lsm6dsox_mag_x_orient_set(stmdev_ctx_t *ctx, lsm6dsox_mag_x_axis_t val)
{
   lsm6dsox_mag_cfg_b_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_CFG_B, (uint8_t*)&reg);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_mag_x_orient_get(stmdev_ctx_t *ctx, lsm6dsox_mag_x_axis_t *val)
{
   lsm6dsox_mag_cfg_b_t reg;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_MAG_CFG_B, (uint8_t*)&reg);
...
static nrfx_err_t lsm6dsox_long_cnt_flag_data_ready_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_emb_func_status_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_long_cnt_set(stmdev_ctx_t *ctx, uint16_t val)
{
   uint8_t buff[2];
   buff[1] = (uint8_t) (val / 256U);
   buff[0] = (uint8_t) (val - (buff[1] * 256U));
...
static nrfx_err_t lsm6dsox_long_cnt_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t buff[2];
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_long_clr_set(stmdev_ctx_t *ctx, lsm6dsox_fsm_lc_clr_t val)
{
...
static nrfx_err_t lsm6dsox_long_clr_get(stmdev_ctx_t *ctx, lsm6dsox_fsm_lc_clr_t *val)
{
   lsm6dsox_fsm_long_counter_clear_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_EMBEDDED_FUNC_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_long_cnt_int_value_set(stmdev_ctx_t *ctx, uint16_t val)
{
   uint8_t add_l;
   uint8_t add_h;
   add_h = (uint8_t)( ( val & 0xFF00U ) >> 8 );
   add_l = (uint8_t)( val & 0x00FFU );
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_L, &add_l);
   if (ret == NRFX_SUCCESS)
      ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_H, &add_h);
   return ret;
}

static nrfx_err_t lsm6dsox_long_cnt_int_value_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t add_l;
   uint8_t add_h;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_LC_TIMEOUT_L, &add_l);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_fsm_number_of_programs_set(stmdev_ctx_t *ctx, uint8_t val)
{
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_PROGRAMS, &val);
   return ret;
}

static nrfx_err_t lsm6dsox_fsm_number_of_programs_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_PROGRAMS, val);
   return ret;
}

static nrfx_err_t lsm6dsox_fsm_start_address_set(stmdev_ctx_t *ctx, uint16_t val)
{
   uint8_t add_l;
   uint8_t add_h;
   add_h = (uint8_t)( ( val & 0xFF00U ) >> 8 );
   add_l = (uint8_t)( val & 0x00FFU );
   nrfx_err_t ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_START_ADD_L, &add_l);
   if (ret == NRFX_SUCCESS)
      ret = lsm6dsox_ln_pg_write_byte(ctx, LSM6DSOX_FSM_START_ADD_H, &add_h);
   return ret;
}

static nrfx_err_t lsm6dsox_fsm_start_address_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   uint8_t add_l;
   uint8_t add_h;
   nrfx_err_t ret = lsm6dsox_ln_pg_read_byte(ctx, LSM6DSOX_FSM_START_ADD_L, &add_l);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_sh_slave_connected_set(stmdev_ctx_t *ctx, lsm6dsox_aux_sens_on_t val)
{
...
static nrfx_err_t lsm6dsox_sh_slave_connected_get(stmdev_ctx_t *ctx, lsm6dsox_aux_sens_on_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_master_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_master_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_pin_mode_set(stmdev_ctx_t *ctx, lsm6dsox_shub_pu_en_t val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_pin_mode_get(stmdev_ctx_t *ctx, lsm6dsox_shub_pu_en_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_pass_through_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_pass_through_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_syncro_mode_set(stmdev_ctx_t *ctx, lsm6dsox_start_config_t val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_syncro_mode_get(stmdev_ctx_t *ctx, lsm6dsox_start_config_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_write_mode_set(stmdev_ctx_t *ctx, lsm6dsox_write_once_t val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_write_mode_get(stmdev_ctx_t *ctx, lsm6dsox_write_once_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_reset_set(stmdev_ctx_t *ctx)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_reset_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_master_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_data_rate_set(stmdev_ctx_t *ctx, lsm6dsox_shub_odr_t val)
{
   lsm6dsox_slv0_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_data_rate_get(stmdev_ctx_t *ctx, lsm6dsox_shub_odr_t *val)
{
   lsm6dsox_slv0_config_t reg;
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_sh_cfg_write(stmdev_ctx_t *ctx, lsm6dsox_sh_cfg_write_t *val)
{
...
static nrfx_err_t lsm6dsox_sh_slv0_cfg_read(stmdev_ctx_t *ctx, lsm6dsox_sh_cfg_read_t *val)
{
...
static nrfx_err_t lsm6dsox_sh_slv1_cfg_read(stmdev_ctx_t *ctx, lsm6dsox_sh_cfg_read_t *val)
{
...
static nrfx_err_t lsm6dsox_sh_slv2_cfg_read(stmdev_ctx_t *ctx, lsm6dsox_sh_cfg_read_t *val)
{
...
static nrfx_err_t lsm6dsox_sh_slv3_cfg_read(stmdev_ctx_t *ctx, lsm6dsox_sh_cfg_read_t *val)
{
...
static nrfx_err_t lsm6dsox_sh_status_get(stmdev_ctx_t *ctx, lsm6dsox_status_master_t *val)
{
   nrfx_err_t ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_SENSOR_HUB_BANK);
   if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_s4s_tph_res_set(stmdev_ctx_t *ctx, lsm6dsox_s4s_tph_res_t val)
{
   lsm6dsox_s4s_tph_l_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_TPH_L, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_s4s_tph_res_get(stmdev_ctx_t *ctx, lsm6dsox_s4s_tph_res_t *val)
{
   lsm6dsox_s4s_tph_l_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_TPH_L, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_s4s_tph_val_set(stmdev_ctx_t *ctx, uint16_t val)
{
   lsm6dsox_s4s_tph_l_t s4s_tph_l;
   lsm6dsox_s4s_tph_h_t s4s_tph_h;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_TPH_L, (uint8_t*)&s4s_tph_l, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_s4s_tph_val_get(stmdev_ctx_t *ctx, uint16_t *val)
{
   lsm6dsox_s4s_tph_l_t s4s_tph_l;
   lsm6dsox_s4s_tph_h_t s4s_tph_h;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_TPH_L, (uint8_t*)&s4s_tph_l, 1);
...
static nrfx_err_t lsm6dsox_s4s_res_ratio_set(stmdev_ctx_t *ctx, lsm6dsox_s4s_res_ratio_t val)
{
   lsm6dsox_s4s_rr_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_RR, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.rr = (uint8_t)val;
...
static nrfx_err_t lsm6dsox_s4s_res_ratio_get(stmdev_ctx_t *ctx, lsm6dsox_s4s_res_ratio_t *val)
{
   lsm6dsox_s4s_rr_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_RR, (uint8_t*)&reg, 1);
   switch (reg.rr)
...
static nrfx_err_t lsm6dsox_s4s_command_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_s4s_st_cmd_code_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_ST_CMD_CODE, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_s4s_command_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_s4s_st_cmd_code_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_ST_CMD_CODE, (uint8_t*)&reg, 1);
...
static nrfx_err_t lsm6dsox_s4s_dt_set(stmdev_ctx_t *ctx, uint8_t val)
{
   lsm6dsox_s4s_dt_reg_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_DT_REG, (uint8_t*)&reg, 1);
   if (ret == NRFX_SUCCESS)
   {
      reg.dt = val;
...
static nrfx_err_t lsm6dsox_s4s_dt_get(stmdev_ctx_t *ctx, uint8_t *val)
{
   lsm6dsox_s4s_dt_reg_t reg;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_S4S_DT_REG, (uint8_t*)&reg, 1);
   *val = reg.dt;
...
static nrfx_err_t lsm6dsox_id_get(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_id_t *val)
{
...
static nrfx_err_t lsm6dsox_init_set(stmdev_ctx_t *ctx, lsm6dsox_init_t val)
{
...
static nrfx_err_t lsm6dsox_bus_mode_set(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_bus_mode_t val)
{
   ...
   if (aux_ctx != NULL)
   {
      ...
      if ((ret == NRFX_SUCCESS) && (spi2_ctrl1_ois.sim_ois != bit_val))
      {
   ...
   if (ctx != NULL)
   {
      ...
      if ((ret == NRFX_SUCCESS) && (ctrl9_xl.i3c_disable != bit_val))
      {
      ...
      if ((ret == NRFX_SUCCESS) && (i3c_bus_avb.i3c_bus_avb_sel != bit_val))
      {
      ...
      if ((ret == NRFX_SUCCESS) && (ctrl4_c.i2c_disable != bit_val))
      {
      ...
      if ((ret == NRFX_SUCCESS) && (ctrl3_c.sim != bit_val))
      {
         ctrl3_c.sim = bit_val;
         ret = lsm6dsox_write_reg(ctx, LSM6DSOX_CTRL3_C, (uint8_t*)&ctrl3_c, 1);
      }
...
static nrfx_err_t lsm6dsox_bus_mode_get(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_bus_mode_t *val)
{
   lsm6dsox_spi2_ctrl1_ois_t spi2_ctrl1_ois;
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   lsm6dsox_ctrl9_xl_t ctrl9_xl;
...
static nrfx_err_t lsm6dsox_status_get(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_status_t *val)
{
   ...
   if (ctx != NULL)
   {
      ...
      if ((ret == NRFX_SUCCESS) && (ctrl3_c.sw_reset == PROPERTY_DISABLE) && (ctrl3_c.boot == PROPERTY_DISABLE))
      {
...
static nrfx_err_t lsm6dsox_pin_conf_set(stmdev_ctx_t *ctx, lsm6dsox_pin_conf_t val)
{
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   lsm6dsox_pin_ctrl_t pin_ctrl;
   lsm6dsox_ctrl3_c_t ctrl3_c;
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_PIN_CTRL, (uint8_t*)&pin_ctrl, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_pin_conf_get(stmdev_ctx_t *ctx, lsm6dsox_pin_conf_t *val)
{
   lsm6dsox_i3c_bus_avb_t i3c_bus_avb;
   lsm6dsox_pin_ctrl_t pin_ctrl;
   lsm6dsox_ctrl3_c_t ctrl3_c;
...
static nrfx_err_t lsm6dsox_interrupt_mode_set(stmdev_ctx_t *ctx, lsm6dsox_int_mode_t val)
{
   lsm6dsox_tap_cfg0_t tap_cfg0;
   lsm6dsox_page_rw_t page_rw;
   lsm6dsox_ctrl3_c_t ctrl3_c;
...
static nrfx_err_t lsm6dsox_interrupt_mode_get(stmdev_ctx_t *ctx, lsm6dsox_int_mode_t *val)
{
   lsm6dsox_tap_cfg0_t tap_cfg0;
   lsm6dsox_page_rw_t page_rw;
   lsm6dsox_ctrl3_c_t ctrl3_c;
...
static nrfx_err_t lsm6dsox_pin_int2_route_get(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_pin_int2_route_t *val)
{
...
static nrfx_err_t lsm6dsox_pin_int1_route_set(stmdev_ctx_t *ctx, lsm6dsox_pin_int1_route_t val)
{
   ...
   nrfx_err_t ret = lsm6dsox_read_reg(ctx, LSM6DSOX_CTRL4_C, (uint8_t*)&ctrl4_c, 1);
   if (ret == NRFX_SUCCESS)
   {
...
static nrfx_err_t lsm6dsox_pin_int1_route_get(stmdev_ctx_t *ctx, lsm6dsox_pin_int1_route_t *val)
{
   lsm6dsox_emb_func_int1_t   emb_func_int1;
   lsm6dsox_fsm_int1_a_t      fsm_int1_a;
   lsm6dsox_fsm_int1_b_t      fsm_int1_b;
...
static nrfx_err_t lsm6dsox_pin_int2_route_set(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_pin_int2_route_t val)
{
   ...
   if (ctx != NULL)
   {
      ...
      if (ret == NRFX_SUCCESS)
      {
         if ((val.fifo_bdr | val.drdy_g | val.drdy_temp | val.drdy_xl | val.fifo_full | val.fifo_ovr | val.fifo_th | val.six_d
               | val.double_tap | val.free_fall | val.wake_up | val.single_tap | val.sleep_change | pin_int1_route.den_flag
               | pin_int1_route.boot | pin_int1_route.fifo_bdr | pin_int1_route.drdy_g | pin_int1_route.drdy_xl | pin_int1_route.fifo_full
               | pin_int1_route.fifo_ovr | pin_int1_route.fifo_th | pin_int1_route.six_d | pin_int1_route.double_tap | pin_int1_route.free_fall
               | pin_int1_route.wake_up | pin_int1_route.single_tap | pin_int1_route.sleep_change ) != PROPERTY_DISABLE)
            tap_cfg2.interrupts_enable = PROPERTY_ENABLE;
         else
            tap_cfg2.interrupts_enable = PROPERTY_DISABLE;
         ret = lsm6dsox_write_reg(ctx, LSM6DSOX_TAP_CFG2, (uint8_t*)&tap_cfg2, 1);
...
static nrfx_err_t lsm6dsox_all_sources_get(stmdev_ctx_t *ctx, lsm6dsox_all_sources_t *val)
{
...
static nrfx_err_t lsm6dsox_mode_set(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_md_t *val)
{
   lsm6dsox_func_cfg_access_t func_cfg_access;
   lsm6dsox_spi2_ctrl1_ois_t spi2_ctrl1_ois;
   ...
   if (ctx != NULL)
   {
      ...
      *(uint8_t*)&ctrl1_xl = reg[0];
      *(uint8_t*)&ctrl2_g = reg[1];
      *(uint8_t*)&ctrl3_c = reg[2];
      *(uint8_t*)&ctrl4_c = reg[3];
      *(uint8_t*)&ctrl5_c = reg[4];
      *(uint8_t*)&ctrl6_c = reg[5];
      *(uint8_t*)&ctrl7_g = reg[6];
      *(uint8_t*)&ctrl8_xl = reg[7];
      if (ret == NRFX_SUCCESS)
         ret = lsm6dsox_read_reg(ctx, LSM6DSOX_FUNC_CFG_ACCESS, (uint8_t*)&func_cfg_access, 1);
   ...
   if (aux_ctx != NULL)
   {
      ...
      *(uint8_t*)&spi2_ctrl1_ois = reg[0];
      *(uint8_t*)&spi2_ctrl2_ois = reg[1];
      *(uint8_t*)&spi2_ctrl3_ois = reg[2];
   }
   else
   {
      if (ctx != NULL)
      {
         ...
         *(uint8_t*)&ui_ctrl1_ois = reg[0];
         *(uint8_t*)&ui_ctrl2_ois = reg[1];
         *(uint8_t*)&ui_ctrl3_ois = reg[2];
      }
   }
   ...
   if (ctx != NULL)
   {
      reg[0] = *(uint8_t*)&ctrl1_xl;
      reg[1] = *(uint8_t*)&ctrl2_g;
      reg[2] = *(uint8_t*)&ctrl3_c;
      reg[3] = *(uint8_t*)&ctrl4_c;
      reg[4] = *(uint8_t*)&ctrl5_c;
      reg[5] = *(uint8_t*)&ctrl6_c;
      reg[6] = *(uint8_t*)&ctrl7_g;
      reg[7] = *(uint8_t*)&ctrl8_xl;
      if (ret == NRFX_SUCCESS)
   ...
   if (aux_ctx != NULL)
   {
      reg[0] = *(uint8_t*)&spi2_ctrl1_ois;
      reg[1] = *(uint8_t*)&spi2_ctrl2_ois;
      reg[2] = *(uint8_t*)&spi2_ctrl3_ois;
      if (ret == NRFX_SUCCESS)
   ...
   else
   {
      if (ctx != NULL)
      {
         reg[0] = *(uint8_t*)&ui_ctrl1_ois;
         reg[1] = *(uint8_t*)&ui_ctrl2_ois;
         reg[2] = *(uint8_t*)&ui_ctrl3_ois;
         if (ret == NRFX_SUCCESS)
...
static nrfx_err_t lsm6dsox_mode_get(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_md_t *val)
{
   ...
   if (ctx != NULL)
   {
      ...
      *(uint8_t*)&ctrl7_g = reg[6];
      ...
      if (ret == NRFX_SUCCESS)
      {
         ...
         *(uint8_t*)&emb_func_odr_cfg_b = reg[0];
         *(uint8_t*)&emb_func_odr_cfg_c = reg[1];
      }
      if (ret == NRFX_SUCCESS)
         ret = lsm6dsox_read_reg(ctx, LSM6DSOX_EMB_FUNC_EN_B, (uint8_t*)&emb_func_en_b, 1);
      if (ret == NRFX_SUCCESS)
      {
         ...
         *(uint8_t*)&fsm_enable_a = reg[0];
         *(uint8_t*)&fsm_enable_b = reg[1];
      }
      if (ret == NRFX_SUCCESS)
         ret = lsm6dsox_mem_bank_set(ctx, LSM6DSOX_USER_BANK);
   }
   ...
   if ((fsm_enable_a.fsm1_en | fsm_enable_a.fsm2_en | fsm_enable_a.fsm3_en |
         ...
         fsm_enable_b.fsm10_en | fsm_enable_b.fsm11_en | fsm_enable_b.fsm12_en | fsm_enable_b.fsm13_en |
         fsm_enable_b.fsm14_en | fsm_enable_b.fsm15_en | fsm_enable_b.fsm16_en) == PROPERTY_ENABLE)
   {
...
static nrfx_err_t lsm6dsox_data_get(stmdev_ctx_t *ctx, stmdev_ctx_t *aux_ctx, lsm6dsox_md_t *md, lsm6dsox_data_t *data)
{
   uint8_t buff[14];
   uint8_t i;
   uint8_t j;
...
bool imu_init(const nrfx_spim_t* spi_instance, nrfx_atomic_flag_t* data_ready)
{
   ...
   // TODO: Turn on and configure the IMU
