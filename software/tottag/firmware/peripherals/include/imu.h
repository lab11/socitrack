...
int32_t lsm6dsox_read_reg(imudev_ctx_t *ctx, uint8_t reg,
                          uint8_t *data,
                          uint16_t len);
int32_t lsm6dsox_write_reg(imudev_ctx_t *ctx, uint8_t reg,
                           uint8_t *data,
                           uint16_t len);
...
int32_t lsm6dsox_xl_full_scale_set(imudev_ctx_t *ctx,
                                   lsm6dsox_fs_xl_t val);
int32_t lsm6dsox_xl_full_scale_get(imudev_ctx_t *ctx,
                                   lsm6dsox_fs_xl_t *val);
...
int32_t lsm6dsox_xl_data_rate_set(imudev_ctx_t *ctx,
                                  lsm6dsox_odr_xl_t val);
int32_t lsm6dsox_xl_data_rate_get(imudev_ctx_t *ctx,
                                  lsm6dsox_odr_xl_t *val);
...
int32_t lsm6dsox_gy_full_scale_set(imudev_ctx_t *ctx,
                                   lsm6dsox_fs_g_t val);
int32_t lsm6dsox_gy_full_scale_get(imudev_ctx_t *ctx,
                                   lsm6dsox_fs_g_t *val);
...
int32_t lsm6dsox_gy_data_rate_set(imudev_ctx_t *ctx,
                                  lsm6dsox_odr_g_t val);
int32_t lsm6dsox_gy_data_rate_get(imudev_ctx_t *ctx,
                                  lsm6dsox_odr_g_t *val);

int32_t lsm6dsox_block_data_update_set(imudev_ctx_t *ctx,
                                       uint8_t val);
int32_t lsm6dsox_block_data_update_get(imudev_ctx_t *ctx,
                                       uint8_t *val);
...
int32_t lsm6dsox_xl_offset_weight_set(imudev_ctx_t *ctx,
                                      lsm6dsox_usr_off_w_t val);
int32_t lsm6dsox_xl_offset_weight_get(imudev_ctx_t *ctx,
                                      lsm6dsox_usr_off_w_t *val);
...
int32_t lsm6dsox_xl_power_mode_set(imudev_ctx_t *ctx,
                                   lsm6dsox_xl_hm_mode_t val);
int32_t lsm6dsox_xl_power_mode_get(imudev_ctx_t *ctx,
                                   lsm6dsox_xl_hm_mode_t *val);
...
int32_t lsm6dsox_gy_power_mode_set(imudev_ctx_t *ctx,
                                   lsm6dsox_g_hm_mode_t val);
int32_t lsm6dsox_gy_power_mode_get(imudev_ctx_t *ctx,
                                   lsm6dsox_g_hm_mode_t *val);

int32_t lsm6dsox_status_reg_get(imudev_ctx_t *ctx,
                                lsm6dsox_status_reg_t *val);

int32_t lsm6dsox_xl_flag_data_ready_get(imudev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_gy_flag_data_ready_get(imudev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_temp_flag_data_ready_get(imudev_ctx_t *ctx,
                                          uint8_t *val);

int32_t lsm6dsox_xl_usr_offset_x_set(imudev_ctx_t *ctx,
                                     uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_x_get(imudev_ctx_t *ctx,
                                     uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_y_set(imudev_ctx_t *ctx,
                                     uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_y_get(imudev_ctx_t *ctx,
                                     uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_z_set(imudev_ctx_t *ctx,
                                     uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_z_get(imudev_ctx_t *ctx,
                                     uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_xl_usr_offset_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_timestamp_rst(imudev_ctx_t *ctx);

int32_t lsm6dsox_timestamp_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_timestamp_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_timestamp_raw_get(imudev_ctx_t *ctx, uint32_t *val);
...
int32_t lsm6dsox_rounding_mode_set(imudev_ctx_t *ctx,
                                   lsm6dsox_rounding_t val);
int32_t lsm6dsox_rounding_mode_get(imudev_ctx_t *ctx,
                                   lsm6dsox_rounding_t *val);
...
int32_t lsm6dsox_rounding_on_status_set(imudev_ctx_t *ctx,
                                        lsm6dsox_rounding_status_t val);
int32_t lsm6dsox_rounding_on_status_get(imudev_ctx_t *ctx,
                                        lsm6dsox_rounding_status_t *val);

int32_t lsm6dsox_temperature_raw_get(imudev_ctx_t *ctx, int16_t *val);

int32_t lsm6dsox_angular_rate_raw_get(imudev_ctx_t *ctx,
                                      int16_t *val);

int32_t lsm6dsox_acceleration_raw_get(imudev_ctx_t *ctx,
                                      int16_t *val);

int32_t lsm6dsox_fifo_out_raw_get(imudev_ctx_t *ctx, uint8_t *buff);

int32_t lsm6dsox_ois_angular_rate_raw_get(imudev_ctx_t *ctx,
                                          int16_t *val);

int32_t lsm6dsox_ois_acceleration_raw_get(imudev_ctx_t *ctx,
                                          int16_t *val);

int32_t lsm6dsox_aux_temperature_raw_get(imudev_ctx_t *ctx,
                                         int16_t *val);

int32_t lsm6dsox_aux_ois_angular_rate_raw_get(imudev_ctx_t *ctx,
                                              int16_t *val);

int32_t lsm6dsox_aux_ois_acceleration_raw_get(imudev_ctx_t *ctx,
                                              int16_t *val);

int32_t lsm6dsox_number_of_steps_get(imudev_ctx_t *ctx,
                                     uint16_t *val);

int32_t lsm6dsox_steps_reset(imudev_ctx_t *ctx);

int32_t lsm6dsox_mlc_out_get(imudev_ctx_t *ctx, uint8_t *buff);

int32_t lsm6dsox_odr_cal_reg_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_odr_cal_reg_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_mem_bank_set(imudev_ctx_t *ctx,
                              lsm6dsox_reg_access_t val);
int32_t lsm6dsox_mem_bank_get(imudev_ctx_t *ctx,
                              lsm6dsox_reg_access_t *val);

int32_t lsm6dsox_ln_pg_write_byte(imudev_ctx_t *ctx, uint16_t address,
                                  uint8_t *val);
int32_t lsm6dsox_ln_pg_read_byte(imudev_ctx_t *ctx, uint16_t address,
                                 uint8_t *val);

int32_t lsm6dsox_ln_pg_write(imudev_ctx_t *ctx, uint16_t address,
                             uint8_t *buf, uint8_t len);
int32_t lsm6dsox_ln_pg_read(imudev_ctx_t *ctx, uint16_t address,
                            uint8_t *val);
...
int32_t lsm6dsox_data_ready_mode_set(imudev_ctx_t *ctx,
                                     lsm6dsox_dataready_pulsed_t val);
int32_t lsm6dsox_data_ready_mode_get(imudev_ctx_t *ctx,
                                     lsm6dsox_dataready_pulsed_t *val);

int32_t lsm6dsox_device_id_get(imudev_ctx_t *ctx, uint8_t *buff);

int32_t lsm6dsox_reset_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_reset_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_auto_increment_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_auto_increment_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_boot_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_boot_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_xl_self_test_set(imudev_ctx_t *ctx,
                                  lsm6dsox_st_xl_t val);
int32_t lsm6dsox_xl_self_test_get(imudev_ctx_t *ctx,
                                  lsm6dsox_st_xl_t *val);
...
int32_t lsm6dsox_gy_self_test_set(imudev_ctx_t *ctx,
                                  lsm6dsox_st_g_t val);
int32_t lsm6dsox_gy_self_test_get(imudev_ctx_t *ctx,
                                  lsm6dsox_st_g_t *val);

int32_t lsm6dsox_xl_filter_lp2_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_xl_filter_lp2_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_gy_filter_lp1_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_gy_filter_lp1_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_filter_settling_mask_set(imudev_ctx_t *ctx,
                                          uint8_t val);
int32_t lsm6dsox_filter_settling_mask_get(imudev_ctx_t *ctx,
                                          uint8_t *val);
...
int32_t lsm6dsox_gy_lp1_bandwidth_set(imudev_ctx_t *ctx,
                                      lsm6dsox_ftype_t val);
int32_t lsm6dsox_gy_lp1_bandwidth_get(imudev_ctx_t *ctx,
                                      lsm6dsox_ftype_t *val);

int32_t lsm6dsox_xl_lp2_on_6d_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_xl_lp2_on_6d_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_xl_hp_path_on_out_set(imudev_ctx_t *ctx,
                                       lsm6dsox_hp_slope_xl_en_t val);
int32_t lsm6dsox_xl_hp_path_on_out_get(imudev_ctx_t *ctx,
                                       lsm6dsox_hp_slope_xl_en_t *val);

int32_t lsm6dsox_xl_fast_settling_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_xl_fast_settling_get(imudev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_xl_hp_path_internal_set(imudev_ctx_t *ctx,
                                         lsm6dsox_slope_fds_t val);
int32_t lsm6dsox_xl_hp_path_internal_get(imudev_ctx_t *ctx,
                                         lsm6dsox_slope_fds_t *val);
...
int32_t lsm6dsox_gy_hp_path_internal_set(imudev_ctx_t *ctx,
                                         lsm6dsox_hpm_g_t val);
int32_t lsm6dsox_gy_hp_path_internal_get(imudev_ctx_t *ctx,
                                         lsm6dsox_hpm_g_t *val);
...
int32_t lsm6dsox_ois_mode_set(imudev_ctx_t *ctx,
                              lsm6dsox_spi2_read_en_t val);
int32_t lsm6dsox_ois_mode_get(imudev_ctx_t *ctx,
                              lsm6dsox_spi2_read_en_t *val);
...
int32_t lsm6dsox_aux_sdo_ocs_mode_set(imudev_ctx_t *ctx,
                                      lsm6dsox_ois_pu_dis_t val);
int32_t lsm6dsox_aux_sdo_ocs_mode_get(imudev_ctx_t *ctx,
                                      lsm6dsox_ois_pu_dis_t *val);
...
int32_t lsm6dsox_aux_pw_on_ctrl_set(imudev_ctx_t *ctx,
                                    lsm6dsox_ois_on_t val);
int32_t lsm6dsox_aux_pw_on_ctrl_get(imudev_ctx_t *ctx,
                                    lsm6dsox_ois_on_t *val);
...
int32_t lsm6dsox_aux_xl_fs_mode_set(imudev_ctx_t *ctx,
                                    lsm6dsox_xl_fs_mode_t val);
int32_t lsm6dsox_aux_xl_fs_mode_get(imudev_ctx_t *ctx,
                                    lsm6dsox_xl_fs_mode_t *val);

int32_t lsm6dsox_aux_status_reg_get(imudev_ctx_t *ctx,
                                    lsm6dsox_spi2_status_reg_ois_t *val);

int32_t lsm6dsox_aux_xl_flag_data_ready_get(imudev_ctx_t *ctx,
                                            uint8_t *val);

int32_t lsm6dsox_aux_gy_flag_data_ready_get(imudev_ctx_t *ctx,
                                            uint8_t *val);

int32_t lsm6dsox_aux_gy_flag_settling_get(imudev_ctx_t *ctx,
                                          uint8_t *val);
...
int32_t lsm6dsox_aux_den_polarity_set(imudev_ctx_t *ctx,
                                      lsm6dsox_den_lh_ois_t val);
int32_t lsm6dsox_aux_den_polarity_get(imudev_ctx_t *ctx,
                                      lsm6dsox_den_lh_ois_t *val);
...
int32_t lsm6dsox_aux_den_mode_set(imudev_ctx_t *ctx,
                                  lsm6dsox_lvl2_ois_t val);
int32_t lsm6dsox_aux_den_mode_get(imudev_ctx_t *ctx,
                                  lsm6dsox_lvl2_ois_t *val);

int32_t lsm6dsox_aux_drdy_on_int2_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_aux_drdy_on_int2_get(imudev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_aux_mode_set(imudev_ctx_t *ctx,
                              lsm6dsox_ois_en_spi2_t val);
int32_t lsm6dsox_aux_mode_get(imudev_ctx_t *ctx,
                              lsm6dsox_ois_en_spi2_t *val);
...
int32_t lsm6dsox_aux_gy_full_scale_set(imudev_ctx_t *ctx,
                                       lsm6dsox_fs_g_ois_t val);
int32_t lsm6dsox_aux_gy_full_scale_get(imudev_ctx_t *ctx,
                                       lsm6dsox_fs_g_ois_t *val);
...
int32_t lsm6dsox_aux_spi_mode_set(imudev_ctx_t *ctx,
                                  lsm6dsox_sim_ois_t val);
int32_t lsm6dsox_aux_spi_mode_get(imudev_ctx_t *ctx,
                                  lsm6dsox_sim_ois_t *val);
...
int32_t lsm6dsox_aux_gy_lp1_bandwidth_set(imudev_ctx_t *ctx,
                                          lsm6dsox_ftype_ois_t val);
int32_t lsm6dsox_aux_gy_lp1_bandwidth_get(imudev_ctx_t *ctx,
                                          lsm6dsox_ftype_ois_t *val);
...
int32_t lsm6dsox_aux_gy_hp_bandwidth_set(imudev_ctx_t *ctx,
                                         lsm6dsox_hpm_ois_t val);
int32_t lsm6dsox_aux_gy_hp_bandwidth_get(imudev_ctx_t *ctx,
                                         lsm6dsox_hpm_ois_t *val);
...
int32_t lsm6dsox_aux_gy_clamp_set(imudev_ctx_t *ctx,
                                  lsm6dsox_st_ois_clampdis_t val);
int32_t lsm6dsox_aux_gy_clamp_get(imudev_ctx_t *ctx,
                                  lsm6dsox_st_ois_clampdis_t *val);
...
int32_t lsm6dsox_aux_xl_bandwidth_set(imudev_ctx_t *ctx,
                                      lsm6dsox_filter_xl_conf_ois_t val);
int32_t lsm6dsox_aux_xl_bandwidth_get(imudev_ctx_t *ctx,
                                      lsm6dsox_filter_xl_conf_ois_t *val);
...
int32_t lsm6dsox_aux_xl_full_scale_set(imudev_ctx_t *ctx,
                                       lsm6dsox_fs_xl_ois_t val);
int32_t lsm6dsox_aux_xl_full_scale_get(imudev_ctx_t *ctx,
                                       lsm6dsox_fs_xl_ois_t *val);
...
int32_t lsm6dsox_sdo_sa0_mode_set(imudev_ctx_t *ctx,
                                  lsm6dsox_sdo_pu_en_t val);
int32_t lsm6dsox_sdo_sa0_mode_get(imudev_ctx_t *ctx,
                                  lsm6dsox_sdo_pu_en_t *val);
...
int32_t lsm6dsox_spi_mode_set(imudev_ctx_t *ctx, lsm6dsox_sim_t val);
int32_t lsm6dsox_spi_mode_get(imudev_ctx_t *ctx, lsm6dsox_sim_t *val);
...
int32_t lsm6dsox_i2c_interface_set(imudev_ctx_t *ctx,
                                   lsm6dsox_i2c_disable_t val);
int32_t lsm6dsox_i2c_interface_get(imudev_ctx_t *ctx,
                                   lsm6dsox_i2c_disable_t *val);
...
int32_t lsm6dsox_i3c_disable_set(imudev_ctx_t *ctx,
                                 lsm6dsox_i3c_disable_t val);
int32_t lsm6dsox_i3c_disable_get(imudev_ctx_t *ctx,
                                 lsm6dsox_i3c_disable_t *val);
...
int32_t lsm6dsox_pin_mode_set(imudev_ctx_t *ctx,
                              lsm6dsox_pp_od_t val);
int32_t lsm6dsox_pin_mode_get(imudev_ctx_t *ctx,
                              lsm6dsox_pp_od_t *val);
...
int32_t lsm6dsox_pin_polarity_set(imudev_ctx_t *ctx,
                                  lsm6dsox_h_lactive_t val);
int32_t lsm6dsox_pin_polarity_get(imudev_ctx_t *ctx,
                                  lsm6dsox_h_lactive_t *val);

int32_t lsm6dsox_all_on_int1_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_all_on_int1_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_int_notification_set(imudev_ctx_t *ctx,
                                      lsm6dsox_lir_t val);
int32_t lsm6dsox_int_notification_get(imudev_ctx_t *ctx,
                                      lsm6dsox_lir_t *val);
...
int32_t lsm6dsox_wkup_ths_weight_set(imudev_ctx_t *ctx,
                                     lsm6dsox_wake_ths_w_t val);
int32_t lsm6dsox_wkup_ths_weight_get(imudev_ctx_t *ctx,
                                     lsm6dsox_wake_ths_w_t *val);

int32_t lsm6dsox_wkup_threshold_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_wkup_threshold_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_xl_usr_offset_on_wkup_set(imudev_ctx_t *ctx,
                                           uint8_t val);
int32_t lsm6dsox_xl_usr_offset_on_wkup_get(imudev_ctx_t *ctx,
                                           uint8_t *val);

int32_t lsm6dsox_wkup_dur_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_wkup_dur_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_gy_sleep_mode_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_gy_sleep_mode_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_act_pin_notification_set(imudev_ctx_t *ctx,
                                          lsm6dsox_sleep_status_on_int_t val);
int32_t lsm6dsox_act_pin_notification_get(imudev_ctx_t *ctx,
                                          lsm6dsox_sleep_status_on_int_t *val);
...
int32_t lsm6dsox_act_mode_set(imudev_ctx_t *ctx,
                              lsm6dsox_inact_en_t val);
int32_t lsm6dsox_act_mode_get(imudev_ctx_t *ctx,
                              lsm6dsox_inact_en_t *val);

int32_t lsm6dsox_act_sleep_dur_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_act_sleep_dur_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_tap_detection_on_z_set(imudev_ctx_t *ctx,
                                        uint8_t val);
int32_t lsm6dsox_tap_detection_on_z_get(imudev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_tap_detection_on_y_set(imudev_ctx_t *ctx,
                                        uint8_t val);
int32_t lsm6dsox_tap_detection_on_y_get(imudev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_tap_detection_on_x_set(imudev_ctx_t *ctx,
                                        uint8_t val);
int32_t lsm6dsox_tap_detection_on_x_get(imudev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_tap_threshold_x_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_tap_threshold_x_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_tap_axis_priority_set(imudev_ctx_t *ctx,
                                       lsm6dsox_tap_priority_t val);
int32_t lsm6dsox_tap_axis_priority_get(imudev_ctx_t *ctx,
                                       lsm6dsox_tap_priority_t *val);

int32_t lsm6dsox_tap_threshold_y_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_tap_threshold_y_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_tap_threshold_z_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_tap_threshold_z_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_tap_shock_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_tap_shock_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_tap_quiet_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_tap_quiet_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_tap_dur_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_tap_dur_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_tap_mode_set(imudev_ctx_t *ctx,
                              lsm6dsox_single_double_tap_t val);
int32_t lsm6dsox_tap_mode_get(imudev_ctx_t *ctx,
                              lsm6dsox_single_double_tap_t *val);
...
int32_t lsm6dsox_6d_threshold_set(imudev_ctx_t *ctx,
                                  lsm6dsox_sixd_ths_t val);
int32_t lsm6dsox_6d_threshold_get(imudev_ctx_t *ctx,
                                  lsm6dsox_sixd_ths_t *val);

int32_t lsm6dsox_4d_mode_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_4d_mode_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_ff_threshold_set(imudev_ctx_t *ctx,
                                  lsm6dsox_ff_ths_t val);
int32_t lsm6dsox_ff_threshold_get(imudev_ctx_t *ctx,
                                  lsm6dsox_ff_ths_t *val);

int32_t lsm6dsox_ff_dur_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_ff_dur_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_fifo_watermark_set(imudev_ctx_t *ctx, uint16_t val);
int32_t lsm6dsox_fifo_watermark_get(imudev_ctx_t *ctx, uint16_t *val);

int32_t lsm6dsox_compression_algo_init_set(imudev_ctx_t *ctx,
                                           uint8_t val);
int32_t lsm6dsox_compression_algo_init_get(imudev_ctx_t *ctx,
                                           uint8_t *val);
...
int32_t lsm6dsox_compression_algo_set(imudev_ctx_t *ctx,
                                      lsm6dsox_uncoptr_rate_t val);
int32_t lsm6dsox_compression_algo_get(imudev_ctx_t *ctx,
                                      lsm6dsox_uncoptr_rate_t *val);

int32_t lsm6dsox_fifo_virtual_sens_odr_chg_set(imudev_ctx_t *ctx,
                                               uint8_t val);
int32_t lsm6dsox_fifo_virtual_sens_odr_chg_get(imudev_ctx_t *ctx,
                                               uint8_t *val);

int32_t lsm6dsox_compression_algo_real_time_set(imudev_ctx_t *ctx,
                                                uint8_t val);
int32_t lsm6dsox_compression_algo_real_time_get(imudev_ctx_t *ctx,
                                                uint8_t *val);

int32_t lsm6dsox_fifo_stop_on_wtm_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_fifo_stop_on_wtm_get(imudev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_fifo_xl_batch_set(imudev_ctx_t *ctx,
                                   lsm6dsox_bdr_xl_t val);
int32_t lsm6dsox_fifo_xl_batch_get(imudev_ctx_t *ctx,
                                   lsm6dsox_bdr_xl_t *val);
...
int32_t lsm6dsox_fifo_gy_batch_set(imudev_ctx_t *ctx,
                                   lsm6dsox_bdr_gy_t val);
int32_t lsm6dsox_fifo_gy_batch_get(imudev_ctx_t *ctx,
                                   lsm6dsox_bdr_gy_t *val);
...
int32_t lsm6dsox_fifo_mode_set(imudev_ctx_t *ctx,
                               lsm6dsox_fifo_mode_t val);
int32_t lsm6dsox_fifo_mode_get(imudev_ctx_t *ctx,
                               lsm6dsox_fifo_mode_t *val);
...
int32_t lsm6dsox_fifo_temp_batch_set(imudev_ctx_t *ctx,
                                     lsm6dsox_odr_t_batch_t val);
int32_t lsm6dsox_fifo_temp_batch_get(imudev_ctx_t *ctx,
                                     lsm6dsox_odr_t_batch_t *val);
...
int32_t lsm6dsox_fifo_timestamp_decimation_set(imudev_ctx_t *ctx,
                                               lsm6dsox_odr_ts_batch_t val);
int32_t lsm6dsox_fifo_timestamp_decimation_get(imudev_ctx_t *ctx,
                                               lsm6dsox_odr_ts_batch_t *val);
...
int32_t lsm6dsox_fifo_cnt_event_batch_set(imudev_ctx_t *ctx,
                                          lsm6dsox_trig_counter_bdr_t val);
int32_t lsm6dsox_fifo_cnt_event_batch_get(imudev_ctx_t *ctx,
                                          lsm6dsox_trig_counter_bdr_t *val);

int32_t lsm6dsox_rst_batch_counter_set(imudev_ctx_t *ctx,
                                       uint8_t val);
int32_t lsm6dsox_rst_batch_counter_get(imudev_ctx_t *ctx,
                                       uint8_t *val);

int32_t lsm6dsox_batch_counter_threshold_set(imudev_ctx_t *ctx,
                                             uint16_t val);
int32_t lsm6dsox_batch_counter_threshold_get(imudev_ctx_t *ctx,
                                             uint16_t *val);

int32_t lsm6dsox_fifo_data_level_get(imudev_ctx_t *ctx,
                                     uint16_t *val);

int32_t lsm6dsox_fifo_status_get(imudev_ctx_t *ctx,
                                 lsm6dsox_fifo_status2_t *val);

int32_t lsm6dsox_fifo_full_flag_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_fifo_ovr_flag_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_fifo_wtm_flag_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_fifo_sensor_tag_get(imudev_ctx_t *ctx,
                                     lsm6dsox_fifo_tag_t *val);

int32_t lsm6dsox_fifo_pedo_batch_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_fifo_pedo_batch_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_0_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_0_get(imudev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_1_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_1_get(imudev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_2_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_2_get(imudev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_3_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_3_get(imudev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_den_mode_set(imudev_ctx_t *ctx,
                              lsm6dsox_den_mode_t val);
int32_t lsm6dsox_den_mode_get(imudev_ctx_t *ctx,
                              lsm6dsox_den_mode_t *val);
...
int32_t lsm6dsox_den_polarity_set(imudev_ctx_t *ctx,
                                  lsm6dsox_den_lh_t val);
int32_t lsm6dsox_den_polarity_get(imudev_ctx_t *ctx,
                                  lsm6dsox_den_lh_t *val);
...
int32_t lsm6dsox_den_enable_set(imudev_ctx_t *ctx,
                                lsm6dsox_den_xl_g_t val);
int32_t lsm6dsox_den_enable_get(imudev_ctx_t *ctx,
                                lsm6dsox_den_xl_g_t *val);

int32_t lsm6dsox_den_mark_axis_x_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_den_mark_axis_x_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_den_mark_axis_y_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_den_mark_axis_y_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_den_mark_axis_z_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_den_mark_axis_z_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_pedo_sens_set(imudev_ctx_t *ctx,
                               lsm6dsox_pedo_md_t val);
int32_t lsm6dsox_pedo_sens_get(imudev_ctx_t *ctx,
                               lsm6dsox_pedo_md_t *val);

int32_t lsm6dsox_pedo_step_detect_get(imudev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_pedo_debounce_steps_set(imudev_ctx_t *ctx,
                                         uint8_t *buff);
int32_t lsm6dsox_pedo_debounce_steps_get(imudev_ctx_t *ctx,
                                         uint8_t *buff);

int32_t lsm6dsox_pedo_steps_period_set(imudev_ctx_t *ctx,
                                       uint16_t val);
int32_t lsm6dsox_pedo_steps_period_get(imudev_ctx_t *ctx,
                                       uint16_t *val);

int32_t lsm6dsox_pedo_adv_detection_set(imudev_ctx_t *ctx,
                                        uint8_t val);
int32_t lsm6dsox_pedo_adv_detection_get(imudev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_pedo_false_step_rejection_set(imudev_ctx_t *ctx,
                                               uint8_t val);
int32_t lsm6dsox_pedo_false_step_rejection_get(imudev_ctx_t *ctx,
                                               uint8_t *val);
...
int32_t lsm6dsox_pedo_int_mode_set(imudev_ctx_t *ctx,
                                   lsm6dsox_carry_count_en_t val);
int32_t lsm6dsox_pedo_int_mode_get(imudev_ctx_t *ctx,
                                   lsm6dsox_carry_count_en_t *val);

int32_t lsm6dsox_motion_flag_data_ready_get(imudev_ctx_t *ctx,
                                            uint8_t *val);

int32_t lsm6dsox_tilt_flag_data_ready_get(imudev_ctx_t *ctx,
                                          uint8_t *val);

int32_t lsm6dsox_sh_mag_sensitivity_set(imudev_ctx_t *ctx,
                                        uint16_t val);
int32_t lsm6dsox_sh_mag_sensitivity_get(imudev_ctx_t *ctx,
                                        uint16_t *val);

int32_t lsm6dsox_mlc_mag_sensitivity_set(imudev_ctx_t *ctx,
                                         uint16_t val);
int32_t lsm6dsox_mlc_mag_sensitivity_get(imudev_ctx_t *ctx,
                                         uint16_t *val);

int32_t lsm6dsox_mag_offset_set(imudev_ctx_t *ctx, int16_t *val);
int32_t lsm6dsox_mag_offset_get(imudev_ctx_t *ctx, int16_t *val);

int32_t lsm6dsox_mag_soft_iron_set(imudev_ctx_t *ctx, uint16_t *val);
int32_t lsm6dsox_mag_soft_iron_get(imudev_ctx_t *ctx, uint16_t *val);
...
int32_t lsm6dsox_mag_z_orient_set(imudev_ctx_t *ctx,
                                  lsm6dsox_mag_z_axis_t val);
int32_t lsm6dsox_mag_z_orient_get(imudev_ctx_t *ctx,
                                  lsm6dsox_mag_z_axis_t *val);
...
int32_t lsm6dsox_mag_y_orient_set(imudev_ctx_t *ctx,
                                  lsm6dsox_mag_y_axis_t val);
int32_t lsm6dsox_mag_y_orient_get(imudev_ctx_t *ctx,
                                  lsm6dsox_mag_y_axis_t *val);
...
int32_t lsm6dsox_mag_x_orient_set(imudev_ctx_t *ctx,
                                  lsm6dsox_mag_x_axis_t val);
int32_t lsm6dsox_mag_x_orient_get(imudev_ctx_t *ctx,
                                  lsm6dsox_mag_x_axis_t *val);

int32_t lsm6dsox_long_cnt_flag_data_ready_get(imudev_ctx_t *ctx,
                                              uint8_t *val);
...
int32_t lsm6dsox_fsm_enable_set(imudev_ctx_t *ctx,
                                lsm6dsox_emb_fsm_enable_t *val);
int32_t lsm6dsox_fsm_enable_get(imudev_ctx_t *ctx,
                                lsm6dsox_emb_fsm_enable_t *val);

int32_t lsm6dsox_long_cnt_set(imudev_ctx_t *ctx, uint16_t val);
int32_t lsm6dsox_long_cnt_get(imudev_ctx_t *ctx, uint16_t *val);
...
int32_t lsm6dsox_long_clr_set(imudev_ctx_t *ctx,
                              lsm6dsox_fsm_lc_clr_t val);
int32_t lsm6dsox_long_clr_get(imudev_ctx_t *ctx,
                              lsm6dsox_fsm_lc_clr_t *val);
...
int32_t lsm6dsox_fsm_out_get(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_fsm_data_rate_set(imudev_ctx_t *ctx,
                                   lsm6dsox_fsm_odr_t val);
int32_t lsm6dsox_fsm_data_rate_get(imudev_ctx_t *ctx,
                                   lsm6dsox_fsm_odr_t *val);

int32_t lsm6dsox_fsm_init_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_fsm_init_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_long_cnt_int_value_set(imudev_ctx_t *ctx,
                                        uint16_t val);
int32_t lsm6dsox_long_cnt_int_value_get(imudev_ctx_t *ctx,
                                        uint16_t *val);

int32_t lsm6dsox_fsm_number_of_programs_set(imudev_ctx_t *ctx,
                                            uint8_t val);
int32_t lsm6dsox_fsm_number_of_programs_get(imudev_ctx_t *ctx,
                                            uint8_t *val);

int32_t lsm6dsox_fsm_start_address_set(imudev_ctx_t *ctx,
                                       uint16_t val);
int32_t lsm6dsox_fsm_start_address_get(imudev_ctx_t *ctx,
                                       uint16_t *val);

int32_t lsm6dsox_mlc_status_get(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_mlc_data_rate_set(imudev_ctx_t *ctx,
                                   lsm6dsox_mlc_odr_t val);
int32_t lsm6dsox_mlc_data_rate_get(imudev_ctx_t *ctx,
                                   lsm6dsox_mlc_odr_t *val);
...
int32_t lsm6dsox_sh_read_data_raw_get(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_sh_slave_connected_set(imudev_ctx_t *ctx,
                                        lsm6dsox_aux_sens_on_t val);
int32_t lsm6dsox_sh_slave_connected_get(imudev_ctx_t *ctx,
                                        lsm6dsox_aux_sens_on_t *val);

int32_t lsm6dsox_sh_master_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_master_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_sh_pin_mode_set(imudev_ctx_t *ctx,
                                 lsm6dsox_shub_pu_en_t val);
int32_t lsm6dsox_sh_pin_mode_get(imudev_ctx_t *ctx,
                                 lsm6dsox_shub_pu_en_t *val);

int32_t lsm6dsox_sh_pass_through_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_pass_through_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_sh_syncro_mode_set(imudev_ctx_t *ctx,
                                    lsm6dsox_start_config_t val);
int32_t lsm6dsox_sh_syncro_mode_get(imudev_ctx_t *ctx,
                                    lsm6dsox_start_config_t *val);
...
int32_t lsm6dsox_sh_write_mode_set(imudev_ctx_t *ctx,
                                   lsm6dsox_write_once_t val);
int32_t lsm6dsox_sh_write_mode_get(imudev_ctx_t *ctx,
                                   lsm6dsox_write_once_t *val);

int32_t lsm6dsox_sh_reset_set(imudev_ctx_t *ctx);
int32_t lsm6dsox_sh_reset_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_sh_data_rate_set(imudev_ctx_t *ctx,
                                  lsm6dsox_shub_odr_t val);
int32_t lsm6dsox_sh_data_rate_get(imudev_ctx_t *ctx,
                                  lsm6dsox_shub_odr_t *val);
...
int32_t lsm6dsox_sh_cfg_write(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_sh_slv0_cfg_read(imudev_ctx_t *ctx,
                                  lsm6dsox_sh_cfg_read_t *val);
int32_t lsm6dsox_sh_slv1_cfg_read(imudev_ctx_t *ctx,
                                  lsm6dsox_sh_cfg_read_t *val);
int32_t lsm6dsox_sh_slv2_cfg_read(imudev_ctx_t *ctx,
                                  lsm6dsox_sh_cfg_read_t *val);
int32_t lsm6dsox_sh_slv3_cfg_read(imudev_ctx_t *ctx,
                                  lsm6dsox_sh_cfg_read_t *val);

int32_t lsm6dsox_sh_status_get(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_s4s_tph_res_set(imudev_ctx_t *ctx,
                                 lsm6dsox_s4s_tph_res_t val);
int32_t lsm6dsox_s4s_tph_res_get(imudev_ctx_t *ctx,
                                 lsm6dsox_s4s_tph_res_t *val);

int32_t lsm6dsox_s4s_tph_val_set(imudev_ctx_t *ctx, uint16_t val);
int32_t lsm6dsox_s4s_tph_val_get(imudev_ctx_t *ctx, uint16_t *val);
...
int32_t lsm6dsox_s4s_res_ratio_set(imudev_ctx_t *ctx,
                                   lsm6dsox_s4s_res_ratio_t val);
int32_t lsm6dsox_s4s_res_ratio_get(imudev_ctx_t *ctx,
                                   lsm6dsox_s4s_res_ratio_t *val);

int32_t lsm6dsox_s4s_command_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_s4s_command_get(imudev_ctx_t *ctx, uint8_t *val);

int32_t lsm6dsox_s4s_dt_set(imudev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_s4s_dt_get(imudev_ctx_t *ctx, uint8_t *val);
...
int32_t lsm6dsox_id_get(imudev_ctx_t *ctx, imudev_ctx_t *aux_ctx,
                        lsm6dsox_id_t *val);
...
int32_t lsm6dsox_bus_mode_set(imudev_ctx_t *ctx,
                              imudev_ctx_t *aux_ctx,
                              lsm6dsox_bus_mode_t val);
int32_t lsm6dsox_bus_mode_get(imudev_ctx_t *ctx,
                              imudev_ctx_t *aux_ctx,
                              lsm6dsox_bus_mode_t *val);
...
int32_t lsm6dsox_init_set(imudev_ctx_t *ctx, lsm6dsox_init_t val);
...
int32_t lsm6dsox_status_get(imudev_ctx_t *ctx, imudev_ctx_t *aux_ctx,
...
int32_t lsm6dsox_pin_conf_set(imudev_ctx_t *ctx,
                              lsm6dsox_pin_conf_t val);
int32_t lsm6dsox_pin_conf_get(imudev_ctx_t *ctx,
                              lsm6dsox_pin_conf_t *val);
...
int32_t lsm6dsox_interrupt_mode_set(imudev_ctx_t *ctx,
                                    lsm6dsox_int_mode_t val);
int32_t lsm6dsox_interrupt_mode_get(imudev_ctx_t *ctx,
                                    lsm6dsox_int_mode_t *val);
...
int32_t lsm6dsox_pin_int1_route_set(imudev_ctx_t *ctx,
                                    lsm6dsox_pin_int1_route_t val);
int32_t lsm6dsox_pin_int1_route_get(imudev_ctx_t *ctx,
                                    lsm6dsox_pin_int1_route_t *val);
...
int32_t lsm6dsox_pin_int2_route_set(imudev_ctx_t *ctx,
                                    imudev_ctx_t *aux_ctx,
                                    lsm6dsox_pin_int2_route_t val);
int32_t lsm6dsox_pin_int2_route_get(imudev_ctx_t *ctx,
                                    imudev_ctx_t *aux_ctx,
                                    lsm6dsox_pin_int2_route_t *val);
...
int32_t lsm6dsox_all_sources_get(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_calibration_get(imudev_ctx_t *ctx,
...
int32_t lsm6dsox_mode_set(imudev_ctx_t *ctx, imudev_ctx_t *aux_ctx,
                          lsm6dsox_md_t *val);
int32_t lsm6dsox_mode_get(imudev_ctx_t *ctx, imudev_ctx_t *aux_ctx,
                          lsm6dsox_md_t *val);
...
int32_t lsm6dsox_data_get(imudev_ctx_t *ctx, imudev_ctx_t *aux_ctx,
...
int32_t lsm6dsox_embedded_sens_set(imudev_ctx_t *ctx,
                                   lsm6dsox_emb_sens_t *emb_sens);
int32_t lsm6dsox_embedded_sens_get(imudev_ctx_t *ctx,
                                   lsm6dsox_emb_sens_t *emb_sens);
int32_t lsm6dsox_embedded_sens_off(imudev_ctx_t *ctx);
