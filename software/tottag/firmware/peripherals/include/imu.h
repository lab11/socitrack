...
typedef enum { LSM6DSOX_XL_ODR_OFF = 0, LSM6DSOX_XL_ODR_12Hz5 = 1, LSM6DSOX_XL_ODR_26Hz = 2, LSM6DSOX_XL_ODR_52Hz = 3, LSM6DSOX_XL_ODR_104Hz = 4, LSM6DSOX_XL_ODR_208Hz = 5, LSM6DSOX_XL_ODR_417Hz = 6, LSM6DSOX_XL_ODR_833Hz = 7, LSM6DSOX_XL_ODR_1667Hz = 8, LSM6DSOX_XL_ODR_3333Hz = 9, LSM6DSOX_XL_ODR_6667Hz = 10, LSM6DSOX_XL_ODR_1Hz6 = 11, /* (low power only) */ } lsm6dsox_odr_xl_t;
typedef enum { LSM6DSOX_250dps = 0, LSM6DSOX_125dps = 1, LSM6DSOX_500dps = 2, LSM6DSOX_1000dps = 4, LSM6DSOX_2000dps = 6, } lsm6dsox_fs_g_t;
typedef enum { LSM6DSOX_GY_ODR_OFF = 0, LSM6DSOX_GY_ODR_12Hz5 = 1, LSM6DSOX_GY_ODR_26Hz = 2, LSM6DSOX_GY_ODR_52Hz = 3, LSM6DSOX_GY_ODR_104Hz = 4, LSM6DSOX_GY_ODR_208Hz = 5, LSM6DSOX_GY_ODR_417Hz = 6, LSM6DSOX_GY_ODR_833Hz = 7, LSM6DSOX_GY_ODR_1667Hz = 8, LSM6DSOX_GY_ODR_3333Hz = 9, LSM6DSOX_GY_ODR_6667Hz = 10, } lsm6dsox_odr_g_t;
typedef enum { LSM6DSOX_LSb_1mg = 0, LSM6DSOX_LSb_16mg = 1, } lsm6dsox_usr_off_w_t;
typedef enum { LSM6DSOX_HIGH_PERFORMANCE_MD = 0, LSM6DSOX_LOW_NORMAL_POWER_MD = 1, LSM6DSOX_ULTRA_LOW_POWER_MD = 2, } lsm6dsox_xl_hm_mode_t;
typedef enum { LSM6DSOX_GY_HIGH_PERFORMANCE = 0, LSM6DSOX_GY_NORMAL = 1, } lsm6dsox_g_hm_mode_t;
typedef enum { LSM6DSOX_NO_ROUND = 0, LSM6DSOX_ROUND_XL = 1, LSM6DSOX_ROUND_GY = 2, LSM6DSOX_ROUND_GY_XL = 3, } lsm6dsox_rounding_t;
typedef enum { LSM6DSOX_STAT_RND_DISABLE = 0, LSM6DSOX_STAT_RND_ENABLE = 1, } lsm6dsox_rounding_status_t;
typedef enum { LSM6DSOX_USER_BANK = 0, LSM6DSOX_SENSOR_HUB_BANK = 1, LSM6DSOX_EMBEDDED_FUNC_BANK = 2, } lsm6dsox_reg_access_t;
typedef enum { LSM6DSOX_DRDY_LATCHED = 0, LSM6DSOX_DRDY_PULSED = 1, } lsm6dsox_dataready_pulsed_t;
typedef enum { LSM6DSOX_XL_ST_DISABLE = 0, LSM6DSOX_XL_ST_POSITIVE = 1, LSM6DSOX_XL_ST_NEGATIVE = 2, } lsm6dsox_st_xl_t;
typedef enum { LSM6DSOX_GY_ST_DISABLE = 0, LSM6DSOX_GY_ST_POSITIVE = 1, LSM6DSOX_GY_ST_NEGATIVE = 3, } lsm6dsox_st_g_t;
typedef enum { LSM6DSOX_ULTRA_LIGHT = 0, LSM6DSOX_VERY_LIGHT = 1, LSM6DSOX_LIGHT = 2, LSM6DSOX_MEDIUM = 3, LSM6DSOX_STRONG = 4, LSM6DSOX_VERY_STRONG = 5, LSM6DSOX_AGGRESSIVE = 6, LSM6DSOX_XTREME = 7, } lsm6dsox_ftype_t;
typedef enum { LSM6DSOX_HP_PATH_DISABLE_ON_OUT = 0x00, LSM6DSOX_SLOPE_ODR_DIV_4 = 0x10, LSM6DSOX_HP_ODR_DIV_10 = 0x11, LSM6DSOX_HP_ODR_DIV_20 = 0x12, LSM6DSOX_HP_ODR_DIV_45 = 0x13, LSM6DSOX_HP_ODR_DIV_100 = 0x14, LSM6DSOX_HP_ODR_DIV_200 = 0x15, LSM6DSOX_HP_ODR_DIV_400 = 0x16, LSM6DSOX_HP_ODR_DIV_800 = 0x17, LSM6DSOX_HP_REF_MD_ODR_DIV_10 = 0x31, LSM6DSOX_HP_REF_MD_ODR_DIV_20 = 0x32, LSM6DSOX_HP_REF_MD_ODR_DIV_45 = 0x33, LSM6DSOX_HP_REF_MD_ODR_DIV_100 = 0x34, LSM6DSOX_HP_REF_MD_ODR_DIV_200 = 0x35, LSM6DSOX_HP_REF_MD_ODR_DIV_400 = 0x36, LSM6DSOX_HP_REF_MD_ODR_DIV_800 = 0x37, LSM6DSOX_LP_ODR_DIV_10 = 0x01, LSM6DSOX_LP_ODR_DIV_20 = 0x02, LSM6DSOX_LP_ODR_DIV_45 = 0x03, LSM6DSOX_LP_ODR_DIV_100 = 0x04, LSM6DSOX_LP_ODR_DIV_200 = 0x05, LSM6DSOX_LP_ODR_DIV_400 = 0x06, LSM6DSOX_LP_ODR_DIV_800 = 0x07, } lsm6dsox_hp_slope_xl_en_t;
typedef enum { LSM6DSOX_USE_SLOPE = 0, LSM6DSOX_USE_HPF = 1, } lsm6dsox_slope_fds_t;
typedef enum { LSM6DSOX_HP_FILTER_NONE = 0x00, LSM6DSOX_HP_FILTER_16mHz = 0x80, LSM6DSOX_HP_FILTER_65mHz = 0x81, LSM6DSOX_HP_FILTER_260mHz = 0x82, LSM6DSOX_HP_FILTER_1Hz04 = 0x83, } lsm6dsox_hpm_g_t;
typedef enum { LSM6DSOX_OIS_CTRL_AUX_DATA_UI = 0x00, LSM6DSOX_OIS_CTRL_AUX_DATA_UI_AUX = 0x01, LSM6DSOX_OIS_CTRL_UI_AUX_DATA_UI = 0x02, LSM6DSOX_OIS_CTRL_UI_AUX_DATA_UI_AUX = 0x03, } lsm6dsox_spi2_read_en_t;
typedef enum { LSM6DSOX_AUX_PULL_UP_DISC = 0, LSM6DSOX_AUX_PULL_UP_CONNECT = 1, } lsm6dsox_ois_pu_dis_t;
typedef enum { LSM6DSOX_AUX_ON = 1, LSM6DSOX_AUX_ON_BY_AUX_INTERFACE = 0, } lsm6dsox_ois_on_t;
typedef enum { LSM6DSOX_USE_SAME_XL_FS = 0, LSM6DSOX_USE_DIFFERENT_XL_FS = 1, } lsm6dsox_xl_fs_mode_t;
typedef enum { LSM6DSOX_AUX_DEN_ACTIVE_LOW = 0, LSM6DSOX_AUX_DEN_ACTIVE_HIGH = 1, } lsm6dsox_den_lh_ois_t;
typedef enum { LSM6DSOX_AUX_DEN_DISABLE = 0, LSM6DSOX_AUX_DEN_LEVEL_LATCH = 3, LSM6DSOX_AUX_DEN_LEVEL_TRIG = 2, } lsm6dsox_lvl2_ois_t;
typedef enum { LSM6DSOX_AUX_DISABLE = 0, LSM6DSOX_MODE_3_GY = 1, LSM6DSOX_MODE_4_GY_XL = 3, } lsm6dsox_ois_en_spi2_t;
typedef enum { LSM6DSOX_250dps_AUX = 0, LSM6DSOX_125dps_AUX = 1, LSM6DSOX_500dps_AUX = 2, LSM6DSOX_1000dps_AUX = 4, LSM6DSOX_2000dps_AUX = 6, } lsm6dsox_fs_g_ois_t;
typedef enum { LSM6DSOX_AUX_SPI_4_WIRE = 0, LSM6DSOX_AUX_SPI_3_WIRE = 1, } lsm6dsox_sim_ois_t;
typedef enum { LSM6DSOX_351Hz39 = 0, LSM6DSOX_236Hz63 = 1, LSM6DSOX_172Hz70 = 2, LSM6DSOX_937Hz91 = 3, } lsm6dsox_ftype_ois_t;
typedef enum { LSM6DSOX_AUX_HP_DISABLE = 0x00, LSM6DSOX_AUX_HP_Hz016 = 0x10, LSM6DSOX_AUX_HP_Hz065 = 0x11, LSM6DSOX_AUX_HP_Hz260 = 0x12, LSM6DSOX_AUX_HP_1Hz040 = 0x13, } lsm6dsox_hpm_ois_t;
typedef enum { LSM6DSOX_ENABLE_CLAMP = 0, LSM6DSOX_DISABLE_CLAMP = 1, } lsm6dsox_st_ois_clampdis_t;
typedef enum { LSM6DSOX_289Hz = 0, LSM6DSOX_258Hz = 1, LSM6DSOX_120Hz = 2, LSM6DSOX_65Hz2 = 3, LSM6DSOX_33Hz2 = 4, LSM6DSOX_16Hz6 = 5, LSM6DSOX_8Hz30 = 6, LSM6DSOX_4Hz15 = 7, } lsm6dsox_filter_xl_conf_ois_t;
typedef enum { LSM6DSOX_AUX_2g = 0, LSM6DSOX_AUX_16g = 1, LSM6DSOX_AUX_4g = 2, LSM6DSOX_AUX_8g = 3, } lsm6dsox_fs_xl_ois_t;
typedef enum { LSM6DSOX_PULL_UP_DISC = 0, LSM6DSOX_PULL_UP_CONNECT = 1, } lsm6dsox_sdo_pu_en_t;
typedef enum { LSM6DSOX_SPI_4_WIRE = 0, LSM6DSOX_SPI_3_WIRE = 1, } lsm6dsox_sim_t;
typedef enum { LSM6DSOX_I2C_ENABLE = 0, LSM6DSOX_I2C_DISABLE = 1, } lsm6dsox_i2c_disable_t;
typedef enum { LSM6DSOX_I3C_DISABLE = 0x80, LSM6DSOX_I3C_ENABLE_T_50us = 0x00, LSM6DSOX_I3C_ENABLE_T_2us = 0x01, LSM6DSOX_I3C_ENABLE_T_1ms = 0x02, LSM6DSOX_I3C_ENABLE_T_25ms = 0x03, } lsm6dsox_i3c_disable_t;
typedef enum { LSM6DSOX_PUSH_PULL = 0x00, LSM6DSOX_OPEN_DRAIN = 0x01, LSM6DSOX_INT1_NOPULL_DOWN_INT2_PUSH_PULL = 0x02, LSM6DSOX_INT1_NOPULL_DOWN_INT2_OPEN_DRAIN = 0x03, } lsm6dsox_pp_od_t;
typedef enum { LSM6DSOX_ACTIVE_HIGH = 0, LSM6DSOX_ACTIVE_LOW = 1, } lsm6dsox_h_lactive_t;
typedef enum { LSM6DSOX_ALL_INT_PULSED = 0, LSM6DSOX_BASE_LATCHED_EMB_PULSED = 1, LSM6DSOX_BASE_PULSED_EMB_LATCHED = 2, LSM6DSOX_ALL_INT_LATCHED = 3, } lsm6dsox_lir_t;
typedef enum { LSM6DSOX_LSb_FS_DIV_64 = 0, LSM6DSOX_LSb_FS_DIV_256 = 1, } lsm6dsox_wake_ths_w_t;
typedef enum { LSM6DSOX_DRIVE_SLEEP_CHG_EVENT = 0, LSM6DSOX_DRIVE_SLEEP_STATUS = 1, } lsm6dsox_sleep_status_on_int_t;
typedef enum { LSM6DSOX_XL_AND_GY_NOT_AFFECTED = 0, LSM6DSOX_XL_12Hz5_GY_NOT_AFFECTED = 1, LSM6DSOX_XL_12Hz5_GY_SLEEP = 2, LSM6DSOX_XL_12Hz5_GY_PD = 3, } lsm6dsox_inact_en_t;
typedef enum { LSM6DSOX_XYZ = 0, LSM6DSOX_YXZ = 1, LSM6DSOX_XZY = 2, LSM6DSOX_ZYX = 3, LSM6DSOX_YZX = 5, LSM6DSOX_ZXY = 6, } lsm6dsox_tap_priority_t;
typedef enum { LSM6DSOX_ONLY_SINGLE = 0, LSM6DSOX_BOTH_SINGLE_DOUBLE = 1, } lsm6dsox_single_double_tap_t;
typedef enum { LSM6DSOX_DEG_80 = 0, LSM6DSOX_DEG_70 = 1, LSM6DSOX_DEG_60 = 2, LSM6DSOX_DEG_50 = 3, } lsm6dsox_sixd_ths_t;
typedef enum { LSM6DSOX_FF_TSH_156mg = 0, LSM6DSOX_FF_TSH_219mg = 1, LSM6DSOX_FF_TSH_250mg = 2, LSM6DSOX_FF_TSH_312mg = 3, LSM6DSOX_FF_TSH_344mg = 4, LSM6DSOX_FF_TSH_406mg = 5, LSM6DSOX_FF_TSH_469mg = 6, LSM6DSOX_FF_TSH_500mg = 7, } lsm6dsox_ff_ths_t;
typedef enum { LSM6DSOX_CMP_DISABLE = 0x00, LSM6DSOX_CMP_ALWAYS = 0x04, LSM6DSOX_CMP_8_TO_1 = 0x05, LSM6DSOX_CMP_16_TO_1 = 0x06, LSM6DSOX_CMP_32_TO_1 = 0x07, } lsm6dsox_uncoptr_rate_t;
typedef enum { LSM6DSOX_XL_NOT_BATCHED = 0, LSM6DSOX_XL_BATCHED_AT_12Hz5 = 1, LSM6DSOX_XL_BATCHED_AT_26Hz = 2, LSM6DSOX_XL_BATCHED_AT_52Hz = 3, LSM6DSOX_XL_BATCHED_AT_104Hz = 4, LSM6DSOX_XL_BATCHED_AT_208Hz = 5, LSM6DSOX_XL_BATCHED_AT_417Hz = 6, LSM6DSOX_XL_BATCHED_AT_833Hz = 7, LSM6DSOX_XL_BATCHED_AT_1667Hz = 8, LSM6DSOX_XL_BATCHED_AT_3333Hz = 9, LSM6DSOX_XL_BATCHED_AT_6667Hz = 10, LSM6DSOX_XL_BATCHED_AT_6Hz5 = 11, } lsm6dsox_bdr_xl_t;
typedef enum { LSM6DSOX_GY_NOT_BATCHED = 0, LSM6DSOX_GY_BATCHED_AT_12Hz5 = 1, LSM6DSOX_GY_BATCHED_AT_26Hz = 2, LSM6DSOX_GY_BATCHED_AT_52Hz = 3, LSM6DSOX_GY_BATCHED_AT_104Hz = 4, LSM6DSOX_GY_BATCHED_AT_208Hz = 5, LSM6DSOX_GY_BATCHED_AT_417Hz = 6, LSM6DSOX_GY_BATCHED_AT_833Hz = 7, LSM6DSOX_GY_BATCHED_AT_1667Hz = 8, LSM6DSOX_GY_BATCHED_AT_3333Hz = 9, LSM6DSOX_GY_BATCHED_AT_6667Hz = 10, LSM6DSOX_GY_BATCHED_AT_6Hz5 = 11, } lsm6dsox_bdr_gy_t;
typedef enum { LSM6DSOX_BYPASS_MODE = 0, LSM6DSOX_FIFO_MODE = 1, LSM6DSOX_STREAM_TO_FIFO_MODE = 3, LSM6DSOX_BYPASS_TO_STREAM_MODE = 4, LSM6DSOX_STREAM_MODE = 6, LSM6DSOX_BYPASS_TO_FIFO_MODE = 7, } lsm6dsox_fifo_mode_t;
typedef enum { LSM6DSOX_TEMP_NOT_BATCHED = 0, LSM6DSOX_TEMP_BATCHED_AT_1Hz6 = 1, LSM6DSOX_TEMP_BATCHED_AT_12Hz5 = 2, LSM6DSOX_TEMP_BATCHED_AT_52Hz = 3, } lsm6dsox_odr_t_batch_t;
typedef enum { LSM6DSOX_NO_DECIMATION = 0, LSM6DSOX_DEC_1 = 1, LSM6DSOX_DEC_8 = 2, LSM6DSOX_DEC_32 = 3, } lsm6dsox_odr_ts_batch_t;
typedef enum { LSM6DSOX_XL_BATCH_EVENT = 0, LSM6DSOX_GYRO_BATCH_EVENT = 1, } lsm6dsox_trig_counter_bdr_t;
typedef enum { LSM6DSOX_GYRO_NC_TAG = 1, LSM6DSOX_XL_NC_TAG, LSM6DSOX_TEMPERATURE_TAG, LSM6DSOX_TIMESTAMP_TAG, LSM6DSOX_CFG_CHANGE_TAG, LSM6DSOX_XL_NC_T_2_TAG, LSM6DSOX_XL_NC_T_1_TAG, LSM6DSOX_XL_2XC_TAG, LSM6DSOX_XL_3XC_TAG, LSM6DSOX_GYRO_NC_T_2_TAG, LSM6DSOX_GYRO_NC_T_1_TAG, LSM6DSOX_GYRO_2XC_TAG, LSM6DSOX_GYRO_3XC_TAG, LSM6DSOX_SENSORHUB_SLAVE0_TAG, LSM6DSOX_SENSORHUB_SLAVE1_TAG, LSM6DSOX_SENSORHUB_SLAVE2_TAG, LSM6DSOX_SENSORHUB_SLAVE3_TAG, LSM6DSOX_STEP_CPUNTER_TAG, LSM6DSOX_GAME_ROTATION_TAG, LSM6DSOX_GEOMAG_ROTATION_TAG, LSM6DSOX_ROTATION_TAG, LSM6DSOX_SENSORHUB_NACK_TAG = 0x19, } lsm6dsox_fifo_tag_t;
typedef enum { LSM6DSOX_DEN_DISABLE = 0, LSM6DSOX_LEVEL_FIFO = 6, LSM6DSOX_LEVEL_LETCHED = 3, LSM6DSOX_LEVEL_TRIGGER = 2, LSM6DSOX_EDGE_TRIGGER = 4, } lsm6dsox_den_mode_t;
typedef enum { LSM6DSOX_DEN_ACT_LOW = 0, LSM6DSOX_DEN_ACT_HIGH = 1, } lsm6dsox_den_lh_t;
typedef enum { LSM6DSOX_STAMP_IN_GY_DATA = 0, LSM6DSOX_STAMP_IN_XL_DATA = 1, LSM6DSOX_STAMP_IN_GY_XL_DATA = 2, } lsm6dsox_den_xl_g_t;
typedef enum { LSM6DSOX_PEDO_BASE_MODE = 0x00, LSM6DSOX_FALSE_STEP_REJ = 0x10, LSM6DSOX_FALSE_STEP_REJ_ADV_MODE = 0x30, } lsm6dsox_pedo_md_t;
typedef enum { LSM6DSOX_EVERY_STEP = 0, LSM6DSOX_COUNT_OVERFLOW = 1, } lsm6dsox_carry_count_en_t;
typedef enum { LSM6DSOX_Z_EQ_Y = 0, LSM6DSOX_Z_EQ_MIN_Y = 1, LSM6DSOX_Z_EQ_X = 2, LSM6DSOX_Z_EQ_MIN_X = 3, LSM6DSOX_Z_EQ_MIN_Z = 4, LSM6DSOX_Z_EQ_Z = 5, } lsm6dsox_mag_z_axis_t;
typedef enum { LSM6DSOX_Y_EQ_Y = 0, LSM6DSOX_Y_EQ_MIN_Y = 1, LSM6DSOX_Y_EQ_X = 2, LSM6DSOX_Y_EQ_MIN_X = 3, LSM6DSOX_Y_EQ_MIN_Z = 4, LSM6DSOX_Y_EQ_Z = 5, } lsm6dsox_mag_y_axis_t;
typedef enum { LSM6DSOX_X_EQ_Y = 0, LSM6DSOX_X_EQ_MIN_Y = 1, LSM6DSOX_X_EQ_X = 2, LSM6DSOX_X_EQ_MIN_X = 3, LSM6DSOX_X_EQ_MIN_Z = 4, LSM6DSOX_X_EQ_Z = 5, } lsm6dsox_mag_x_axis_t;
typedef enum { LSM6DSOX_LC_NORMAL = 0, LSM6DSOX_LC_CLEAR = 1, LSM6DSOX_LC_CLEAR_DONE = 2, } lsm6dsox_fsm_lc_clr_t;
typedef enum { LSM6DSOX_ODR_FSM_12Hz5 = 0, LSM6DSOX_ODR_FSM_26Hz = 1, LSM6DSOX_ODR_FSM_52Hz = 2, LSM6DSOX_ODR_FSM_104Hz = 3, } lsm6dsox_fsm_odr_t;
...
typedef enum { LSM6DSOX_SLV_0 = 0, LSM6DSOX_SLV_0_1 = 1, LSM6DSOX_SLV_0_1_2 = 2, LSM6DSOX_SLV_0_1_2_3 = 3, } lsm6dsox_aux_sens_on_t;
typedef enum { LSM6DSOX_EXT_PULL_UP = 0, LSM6DSOX_INTERNAL_PULL_UP = 1, } lsm6dsox_shub_pu_en_t;
typedef enum { LSM6DSOX_EXT_ON_INT2_PIN = 1, LSM6DSOX_XL_GY_DRDY = 0, } lsm6dsox_start_config_t;
typedef enum { LSM6DSOX_EACH_SH_CYCLE = 0, LSM6DSOX_ONLY_FIRST_CYCLE = 1, } lsm6dsox_write_once_t;
typedef enum { LSM6DSOX_SH_ODR_104Hz = 0, LSM6DSOX_SH_ODR_52Hz = 1, LSM6DSOX_SH_ODR_26Hz = 2, LSM6DSOX_SH_ODR_13Hz = 3, } lsm6dsox_shub_odr_t;
typedef enum { LSM6DSOX_S4S_TPH_7bit = 0, LSM6DSOX_S4S_TPH_15bit = 1, } lsm6dsox_s4s_tph_res_t;
typedef enum { LSM6DSOX_S4S_DT_RES_11 = 0, LSM6DSOX_S4S_DT_RES_12 = 1, LSM6DSOX_S4S_DT_RES_13 = 2, LSM6DSOX_S4S_DT_RES_14 = 3, } lsm6dsox_s4s_res_ratio_t;
typedef enum
{
...
// LSM6DSOX register and structure definitions -------------------------------------------------------------------------

#define PROPERTY_DISABLE                      (0U)
#define PROPERTY_ENABLE                       (1U)

#define LSM6DSOX_SPI_READ                     0x80
#define LSM6DSOX_SPI_WRITE                    0x7F
...
typedef struct
{
   ...
   enum
   {
      LSM6DSOX_SPI_4W_AUX = 0x00, LSM6DSOX_SPI_3W_AUX = 0x01,
   } aux_bus_md;
} lsm6dsox_bus_mode_t;
...
typedef struct
{
   struct
   {
      struct
      {
         ...
         enum
         {
            LSM6DSOX_XL_UI_2g = 0, LSM6DSOX_XL_UI_4g = 2, LSM6DSOX_XL_UI_8g = 3, LSM6DSOX_XL_UI_16g = 1, /* OIS full scale is also forced to be 16g */
         } fs;
      } xl;
      struct
      {
         ...
         enum
         {
            LSM6DSOX_GY_UI_250dps = 0, LSM6DSOX_GY_UI_125dps = 1, LSM6DSOX_GY_UI_500dps = 2, LSM6DSOX_GY_UI_1000dps = 4, LSM6DSOX_GY_UI_2000dps = 6,
         } fs;
      } gy;
   } ui;
   struct
   {
      ...
      struct
      {
         ...
         enum
         {
            LSM6DSOX_XL_OIS_2g = 0, LSM6DSOX_XL_OIS_4g = 2, LSM6DSOX_XL_OIS_8g = 3, LSM6DSOX_XL_OIS_16g = 1, /* UI full scale is also forced to be 16g */
         } fs;
      } xl;
      struct
      {
         ...
         enum
         {
            LSM6DSOX_GY_OIS_250dps = 0, LSM6DSOX_GY_OIS_125dps = 1, LSM6DSOX_GY_OIS_500dps = 2, LSM6DSOX_GY_OIS_1000dps = 4, LSM6DSOX_GY_OIS_2000dps = 6,
         } fs;
      } gy;
   } ois;
   struct
   {
      enum
      {
         LSM6DSOX_FSM_DISABLE = 0x00, LSM6DSOX_FSM_XL = 0x01, LSM6DSOX_FSM_GY = 0x02, LSM6DSOX_FSM_XL_GY = 0x03,
      } sens;
      enum
      {
         LSM6DSOX_FSM_12Hz5 = 0x00, LSM6DSOX_FSM_26Hz = 0x01, LSM6DSOX_FSM_52Hz = 0x02, LSM6DSOX_FSM_104Hz = 0x03,
      } odr;
   } fsm;
   struct
   {
      enum
      {
         LSM6DSOX_MLC_DISABLE = 0x00, LSM6DSOX_MLC_XL = 0x01, LSM6DSOX_MLC_XL_GY = 0x03,
      } sens;
      enum
      {
         LSM6DSOX_MLC_12Hz5 = 0x00, LSM6DSOX_MLC_26Hz = 0x01, LSM6DSOX_MLC_52Hz = 0x02, LSM6DSOX_MLC_104Hz = 0x03,
      } odr;
   } mlc;
} lsm6dsox_md_t;
