...
#define ACCEL_SPI_SCLK      NRF_GPIO_PIN_MAP(0,20)
#define ACCEL_SPI_MISO      NRF_GPIO_PIN_MAP(0,24)
#define ACCEL_SPI_MOSI      NRF_GPIO_PIN_MAP(0,22)
#define ACCEL_SPI_BUS       NRFX_SPIM_INSTANCE(0)
...
#define CARRIER_ACC_INT1    NRF_GPIO_PIN_MAP(0,17)
#define CARRIER_ACC_INT2    NRF_GPIO_PIN_MAP(0,15)
